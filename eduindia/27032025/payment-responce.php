...
if($isValidChecksum == "TRUE" && $_POST["STATUS"] == "TXN_SUCCESS")
{
        ...
        $fud = fs('user_register',array('order_id'=>$order_id));
        $g_admin = fs('top_admin',array('type'=>'A'));
        $row = $con->update('user_register',array('payment_status'=>1,'user_add_by_id'=>$g_admin->online_branch_id),array('order_id'=>$order_id));
        if($row==1){
...
<div style="margin-top: 10%;">
	<img src="images/logo/homepagelogo.png">
