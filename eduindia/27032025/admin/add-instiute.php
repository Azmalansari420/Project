...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header"> 
      <h1>All Institutes <small><b> Manage View </b> <a href="<?php e($page_name); ?>" class="btn btn-xs btn-primary">Add New</a></small>
      </h1>
...
<section class="content" id="ppg">
      <div class="row">
        <div class="col-xs-6">
          ...
          <h3 class="box-title"><i class="fa fa-shopping-cart"></i> Add Institutes</h3>
		...
		<div class="col-xs-6">
          ...
          <div class="box box-info">
            <div class="box-header">
          <h3 class="box-title"><i class="fa fa-shopping-cart"></i> All Institutes Details</h3>
