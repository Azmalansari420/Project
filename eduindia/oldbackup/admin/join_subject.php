...
if(isset($add_course_btn)){
		...
		if(count($ss) >=1 ){
			...
			$col_val = array('subject'=>$sub_list);
			$row = $con->update('course',$col_val,$where);
			if($row==1){
				alert('Successful Join Subject with Course','join_subject.php');   
			}
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header"> 
      <h1>Assign Subject To Course<small><b> Manage View </b></small>
      </h1>
...
<section class="content" id="ppg">
	  ...
	  <form action="" method="post">
        <div class="col-xs-12">
          ...
          <h3 class="box-title"><i class="fa fa-shopping-cart"></i> Assign Subject To Course	</h3>
            ...
            <div class="box-body">
					...
					<label for="">Select Course</label>
					  <select required name="s_course" class="form-control select2" id="s_course"> 
					   ...
					   <input type="hidden" class="check_second" value="1">
					</div>
					</div>
					  ...
					  <div class="selected_all_subject" style="display:none;">
					  
					  <div class="row">
					  <h3 style="padding-left:20px;">Selected Course Subject</h3>
					  </div>
					     <div  class="row" id="selected_all_subject">
					...
					<div class="row" id="show_outer_select" style="display:none;">
					<hr>
						  <h3 style="padding-left:20px;">Select Subject</h3>
						  <div class="show_all_subject" id="show_all_subject">
