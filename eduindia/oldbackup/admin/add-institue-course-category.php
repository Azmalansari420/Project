...
//Add     
   if(isset($add_course_btn)){
	   $col_val = array(
			'org_id'=>$o_id,'ins_id'=>$ins_id,'name'=>$name,'description'=>$page_content,'status'=>$status
	      );
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header"> 
      <h1>All Institutes Course Category<small><b> Manage View </b> <a href="<?php e($page_name); ?>" class="btn btn-xs btn-primary">Add New</a></small>
      </h1>
...
<section class="content" id="ppg">
      <div class="row">
		...
		<div class="col-xs-7">
          ...
          <div class="box box-info">
            <div class="box-header">
          <h3 class="box-title"><i class="fa fa-shopping-cart"></i> All Institutes Course Category Details</h3>
