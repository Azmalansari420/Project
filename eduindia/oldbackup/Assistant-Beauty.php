...
<div class="inner-banner has-base-color-overlay text-center" style="background: url(galleryimages/3.jpg);">
    <div class="container">
        <div class="box">
...
<section class="service-single sec-padd">
    <div class="container">
        <div class="row">     
            ...
            <div class="col-md-9">
                <div class="outer-box">
                    <div class="img-box"><img src="galleryimages/3.jpg" alt=""></div>
                    <br><br>
