		...
		if(isset($show_result) || isset($_GET['reg_id'])){
			...
			<div class="panel panel-primary" style="margin-top:50px;">
			          ...
			          <tr><th>Registration Id</th><td><?php e($fs->reg_id);?></td></tr>
							 <tr><th>Student Verification Name</th><td><?php e($fs->name);?></td></tr>
			          ...
			          <tr><th>State *</th><td><?php echo id_to_name('state',$fs->state_id);?></td></tr>
			           
					  </tr>
			           <tr><th>Course name</th>
					  <td><?php $course = fs("tbl_course",array('id' =>$fs->course_id)); ?><?php echo $course->title; ?>
					  </td>
					  </tr>
					  <tr>
							<th>Student Image</th>
							<td>
    							   <?php if($fs->photo){ ?>
                                    <img src="admin_panel/uploads/user/<?php e($fs->photo);?>"  style=" width:100px;">
                                <?php } ?>
