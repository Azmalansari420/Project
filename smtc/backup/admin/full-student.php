			...
			<div class="row">
			    <div class="col-sm-6">
			        <table class="table table-bordered">
			          <tr><th>Student Id</th><td><?php e($fs->student_id_number);?></td></tr>
			          ...
			          <tr><th>DOB </th><td><?php echo date("d M Y",strtotime($fs->dob));?></td></tr>
				...
				<div class="col-sm-6">
			        ...
			        <tr>
					  ...
					  <tr>
							...
							<td><a href="../upload/<?php e(@$fs->cover); ?>" download>
					  ...
					  <tr><th>Last Qualification  *</th><td><?php echo e($fs->last_qualification); ?></td></tr>
 ...
 if(is_array($string_to_array) || is_object($string_to_array)){
     ...
     foreach($string_to_array as $sta){
         echo $user_specialization = id_to_name('specialization',$sta)." <br/>";
				  ...
				  <tr><th>Payment Mode</th><td><?php echo $payment_mode_list[$fs->payment_mode];?></td></tr>
