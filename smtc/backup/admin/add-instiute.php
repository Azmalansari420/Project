...
//Add     
   if(isset($add_course_btn)){
	   $col_val = array('name'=>$name,'description'=>$page_content);
	   ...
	   if($row==1){
		   alert('Successful Add Institutes',$page_name);   
	   }
   }
//update 
   if(isset($update_course_btn)){
	   ...
	   if($row==1){
		   alert('Successful Update Institutes',$page_name);   
	   }
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header"> 
      <h1>All Course Category <small><b> Manage View </b> <a href="<?php e($page_name); ?>" class="btn btn-xs btn-primary">Add New</a></small>
      </h1>
...
<section class="content" id="ppg">
      <div class="row">
        <div class="col-xs-6">
          ...
          <h3 class="box-title"><i class="fa fa-shopping-cart"></i> Add Course Category</h3>
		...
		<div class="col-xs-6">
          ...
          <div class="box box-info">
            <div class="box-header">
          <h3 class="box-title"><i class="fa fa-shopping-cart"></i> All Course Category</h3>
              ...
              <table id="example1" class="table table-hover table-bordered table-striped">
			   ...
			   <th>Delete</th> 
                ...
                <tr class="delete_cat<?=$q_id;?>">
                  <td><?=$i++;?></td> 
				  <td><?=$g->name;?></td>  
				  <td><img style="width:50px;height:50px;" src="../upload/<?=$g->img;?>"/></td>  
