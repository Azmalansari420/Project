...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header"> 
      <h1>All Download <small><b> Manage View </b> <a href="<?php e($page_name); ?>" class="btn btn-xs btn-primary">Add New</a></small>
      </h1>
...
<section class="content" id="ppg">
      <div class="row">
        <div class="col-xs-6">
          ...
          <h3 class="box-title"><i class="fa fa-shopping-cart"></i> Add Download</h3>
            ...
            <div class="box-body">
                 <form action="" enctype="multipart/form-data" method="post">
					<div class="form-group">
					   <input type="text" required name="name" value="<?php e(@$fs->name); ?>"  class="form-control" placeholder="Download Name" />
					</div>
					<div class="form-group">
					   <input type="file" name="ing_img" accept=".pdf"  class="form-control" />
					   <?php if(isset($url_id)){ ?>
					...
					<?php }else{ ?>
						<input type="submit" name="add_course_btn" value="add-instiute" class="btn btn-info" />
					<?php } ?>
		...
		<div class="col-xs-6">
          ...
          <div class="box box-info">
            <div class="box-header">
          <h3 class="box-title"><i class="fa fa-shopping-cart"></i> All Download Details</h3>
              ...
              <table id="example1" class="table table-hover table-bordered table-striped">
			   ...
			   <th>Delete</th> 
                ...
                <tr class="delete_cat<?=$q_id;?>">
				  ...
				  <td><a href="javascript:;" onclick="all_delete(<?=$q_id;?>,'.delete_cat','add_download','ajax_to_php/admin_file','');"><i class="fa fa-trash-o"></i> Delete</a></td> 
                </tr>
					<?php } }?>
