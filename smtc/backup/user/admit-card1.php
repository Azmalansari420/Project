        ...
        <div class="col-xs-12">
          ...
          <div class="box-tools pull-right">
            ...
            <div class="box-body" style="padding:25px;">
              ...
              <iframe style="width:100%;height:350;" src="../upload/<?php echo $fs->admit_card; ?>"></iframe>  <br>
              <a href="../upload/<?php echo $fs->admit_card; ?>" download="<?php echo rand();?>" class="btn btn-info">Download Admit Card</a>
            <?php } ?>
