...
<body>
	<!-- Preloader Start -->
	<!-- <div id="preloader"> <div id="preloader-status"></div> </div> -->
	<!-- Preloader End -->
	<!-- Header Start -->
	<header>
		<!-- Header Topbar Start -->
					...
					<div class="col-md-9 col-sm-8 hidden-xs">
						<div class="header-left">
							<ul>
								...
								<li><i class="fa fa-phone"></i>+91-8851481640</li>
							</ul>	
						</div>
					</div>				
					...
					<div class="col-md-3 col-sm-4 col-xs-12">
						<div class="soical-profile">
								...
								<ul >
									...
									<li class="hidden-sm hidden-lg hidden-md"><a href="online-payment.php"><button type="button" class="flash-button" style="background: #63ab23;">
PAY ONLINE</button></a></li>
								</ul>
							</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-7 col-sm-12 col-xs-12">
						<div class="logo">
							...
							<p class="sub_text text-center" style="font-size: 13px;">REG. UNDER MINISTRY OF CORPORATE AFFAIRS GOVT. OF INDIA. Incorporated Establishment Recognized By:<br>  Labour Ministry, Govt. Of Delhi <br/>(AN ISO 9001:2015 Certified Organization)</p>
						</div>
					</div>
					<div class="col-md-3 col-sm-12 col-xs-8 hidden-xs">
						<div class="soical-profile" style="text-align: center; margin-top: 45px;">
							<ul class="list-inline">
							    <li><a href="online-payment.php"><button type="button" class="flash-button">PAY ONLINE</button></a> </li>
							    <li><button type="button" class="flash-button" data-toggle="modal" data-target="#myModal">Enquiry Now</button></li>
							</ul>
							...
							<nav id="main-menu" class="main-menu">
								<ul>
                                   ...
                                   <li><a href="#">About</a>
                                     ...
                                     <li><a href="why-smtc.php">Why SMTC</a></li>
                                ...
                                <li><a href="#">Courses</a>
                                     <ul>
                                     <!--<li><a href="engineering.php">Engineering Programmes</a></li>-->
                                     <li><a href="management.php">Management Programmes</a></li>
                                     <li><a href="computer.php">Computer Programmes</a></li>
                                     <li><a href="computer-repair.php">Computer Hardware & Software Course</a></li>
                                     <li><a href="laptop-repair.php">Laptop Repairing Course/a></li>
                                     <li><a href="mobile-repair.php">Mobile Repairing Course</a></li>
                                     <li><a href="#">Advance Printer Repairing Course</a></li>
                                 </ul>
                                </li>
                                
                                 <li><a href="user/">Online Exam</a></li>
                                   					
									<!--<li><a href="#">Courses </a>
										<ul>
											 <?php
                                    $fetch_category = $con->all_fetch("institutes",array('status' => "Yes" ),"order by sort_id ASC");

                                    if(is_array($fetch_category) || is_object($fetch_category) && !empty($fetch_category)){
                                    	foreach ($fetch_category as $f_c) {
                                    		$check = $con->all_count("institutes_courses",array('status' => "Yes",'ins_id'=>$f_c->id ),"order by sort_id ASC");
                                   	if($check >=1){
                                   		$a = "#";
                                   	}else{
                                   		$a = "services_details.php?c_id=".$f_c->id;
                                   	}
                                    ?>				
									<li><a href="<?php echo $a; ?>"><?php echo $f_c->name;?></a>
												<ul>
													<?php
											$fetch_sub_category = $con->all_fetch("institutes_courses",array('status' => "Yes",'ins_id'=>$f_c->id ),"order by sort_id ASC");
                                    if(is_array($fetch_sub_category) || is_object($fetch_sub_category) && !empty($fetch_sub_category)){
                                    	foreach ($fetch_sub_category as $f_s_c) {

											?>
													<li><a href="services_details.php?s_id=<?php echo $f_s_c->id;?>"><?php echo $f_s_c->name;?></a></li>										
													<?php } } ?>
									 ...
									 <li><a href="#">Exam</a>
                                    	<ul>
                                    		...
                                    		<li><a href="grading-system.php">Grading System</a></li>
                                    ...
                                    <li><a href="#">Student Zone</a>
                                    	<ul>
                                    		...
                                    		<!-- <li><a href="student_login.php">Student Zone</a></li> -->
                                    		<li><a href="user/">Student Login</a></li>
                                    		<li><a href="smtc.pdf" target="_blank">Download Form</a></li>
                                    		<li><a href="prospectus.pdf" target="_blank">Prospectus SMTC</a></li>
                                    	</ul>
                                    </li>	
                                    <li><a href="user/">Student Login</a></li>
									...
									<li><a href="#">Verification</a>
                                    	<ul>
                                    		...
                                    		<li><a href="marksheet-verification.php">Certificate Verification</a></li> 
                                    	</ul>
                                    </li>
                                    <li><a href="result.php">Result</a></li>
