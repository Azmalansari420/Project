                    ...
                    <tr>
                            ...
                            <table style="width:100%;margin: auto;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><b><?php echo $user[0]->course ?></b></td>
                                    </tr>
                                    <tr>
                                        <th style="text-align:left;">Enrollment No </th>
                                         <td style="text-align:center">:</td>
                                        <th style=""><b><?php echo $user[0]->reg_id ?></b></th>
                                    </tr> 
                                    <tr>
                                        <td style=""><b> Student Name</b> </td>
                                        <td style="text-align:center">:</td>
                                        <td style=""><b><strong><?php echo $user[0]->name ?></strong></b></td>
                                    </tr>
                                    <tr>
                                        <td style=""><b>Father's Name </b></td>
                                         <td style="text-align:center">:</td>
                                        <td style=""><b><?php echo $user[0]->father_name ?></b></td>
                                    </tr>
                                    <tr>
                                        <td style=""><b>Mother's Name </b></td>
                                         <td style="text-align:center">:</td>
                                        <td style=""><b><?php echo $user[0]->mother_name ?></b></td>
                                    </tr>
                                    <?php if($RESULT) { ?>
                                     <tr>
                                        <td style=""><b> Passing Session </b></td>
                                          <td style="text-align:center">:</td>
                                        <td style=""><b><?php echo $RESULT[0]->year ?></b></td>
                                    </tr> 
                                    <tr>
                                        <td style=""><b> Exam Center </b></td>
                                         <td style="text-align:center">:</td>
                                        <td style=""><b><?php echo $RESULT[0]->exam_center_code ?><?php if($RESULT[0]->exam_center_code){ echo "/" ;} ?> <?php echo $RESULT[0]->exam_center ?></b></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                        ...
                        <td style="text-align: right;">
                             <center >
                                 <div class="img">
                                      <?php if($user[0]->photo){ ?>
                                        <img src="<?php echo base_url('uploads/user/'); ?><?php echo $user[0]->photo ;?>" >
                                    <?php } ?>
                                 </div>
                                 <br>
                                   
                                <p><b>DOB: <?php echo date('d-M-Y' ,strtotime($user[0]->dob));?></b></p>
                                <p><b>Student Id: <?php echo $user[0]->student_id_number ;?></b></p>
                            </center>
                ...
                <tr>
                    <td style="text-transform: capitalize;">
                        <center>
                            ...
                            <h5 >Semester <?php echo @$RESULT[0]->semester ?></h5>
                        </center>
                    </td>
                </tr>
             </table>
                ...
                <table style="border: 2px solid #3e3c3c;text-align: left;padding: 8px;font-size:10px; color:black;width: 100%">
                    <thead>
				        ...
				        foreach ($RESULTLIST as $key => $value) { ?>
				            <?php if($value->semester <= $RESULT[0]->semester ) {  ?>
                    ...
                    <br>
            <table style="text-align: left;padding: 8px;font-size:10px; color:black;width: 100%">
               <tr>
                    <td>
                       <h3 style="padding-left:50px">
                        Result : <?php echo $RESULT[0]->result ?>            
                        </h3>
                    </td>
                   <td>
                         </br>
