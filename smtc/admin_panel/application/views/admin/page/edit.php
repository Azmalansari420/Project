    ...
    <!-- Breadcrumb-->
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <li class="breadcrumb-item"><a href="<?php echo  base_url('page/listing')  ?>">Pages </a></li>
                  ...
                  <div class="row mar0" style="padding: 10px">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mar10bot">
                                ...
                                <input type="text" class="form-control" name="title"  placeholder="Enter Title" value="<?php echo $RESULT[0]->title ?>" onkeyup="return set_slug(this.value);"  required="">          
                              </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mar10bot">
                              ...
                              <input type="text" class="form-control"  disabled="" value="<?php echo $RESULT[0]->url_slug ?>">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mar10bot">
                              ...
                              <input type="text" class="form-control" name="youtube_link" id="youtube_link"  value="<?php echo $RESULT[0]->youtube_link ?>">
                        ...
                        <div class="col-sm-6">
                                ...
                                <img src="<?php echo base_url('page/').$RESULT[0]->image; ?>" width="20%">
                                <?php } ?>
                              </div> 
                        </div>
                </div>       
                ...
                <div class="row mar0" style="padding: 10px">
                        ...
                        <div class="col-sm-12">
                              ...
                              <div class="form-group mar10bot">
                                  ...
                                  <textarea class="form-control" id="summernoteEditor2"  name="full_description" placeholder="Enter description"><?php echo $RESULT[0]->full_description ?></textarea>
                              </div>
                              ...
                              <div class="form-group mar10bot">
                                  ...
                                  <input type="text" class="form-control" name="meta_keyword"  placeholder="Enter meta Keywords" value="<?php echo $RESULT[0]->meta_keyword ?>">
                                    <?php echo form_error('meta_keyword'); ?>
                              </div>
                              <div class="form-group mar10bot">
                                  <label for="exampleInputEmail1">Meta description</label>

                                  <textarea class="form-control" name="meta_description"  cols="5" ><?php echo $RESULT[0]->meta_description ?></textarea>
...

{
  ...
  if(confirm_event==true)
  {
    $.ajax({
      ...
      url:'<?php echo base_url('crm/services/image_delete'); ?>',
