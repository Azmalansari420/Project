...
<head>
    ...
    <style>
        ...
        .header-wrapper {
    background: linear-gradient(to right, #00355f, #004b91);
...
<body>
    <header>
        ...
        <!-- Main Bar Start -->
        <div class="hd-sec">
            <div class="container-fluid p-2 p-md-3 bg-primary text-white header-wrapper">
    <marquee class="mb-2 bg-dark text-white p-1 small">
        <?php e(@$fs->marquee); ?>
    </marquee>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-2 col-12 text-center mb-3 mb-md-0">
            <a href="index.php">
                <img src="imge/logo.png" alt="SMTC Logo" class="img-fluid" style="max-heighdt: 80px;background: white;
    padding: 10px;
    border-radius: 5px">
            </a>
        </div>
        ...
        <div class="col-md-7 col-12 text-center text-md-left">
            <h2 class="font-weight-bold mb-1" style="font-sdize: 20px;">
                SAUNIT MANAGEMENT AND TECHNICAL COUNCIL
            </h2>
            <p class="mb-0 small">
                REG. UNDER MINISTRY OF CORPORATE AFFAIRS GOVT. OF INDIA.<br>
                Recognized by Labour Ministry, Govt. of Delhi<br>
                (An ISO 9001:2015 Certified Organization)
            </p>
        </div>

        <!-- Buttons -->
        <div class="col-md-3 col-12 text-center text-md-right mt-3 mt-md-0">
            <a href="online-payment.php" class="btn btn-warning btn-sm mb-2">Pay Online</a>
            <button type="button" class="btn btn-success btn-sm mb-2" data-toggle="modal" data-target="#myModal">Enquiry Now</button>
        </div>
    </div>
</div>
