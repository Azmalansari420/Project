            ...
            <div class="box-body">
                ...
                <?php
                    ...
                    foreach($result as $key=>$value){
                        $resultlatest = $con->get('tbl_result', " where id = '". $value->id."'");
                        $marksheet = $con->get('tbl_result_marksheet',"where result_id = '". $resultlatest[0]->id."' order by id asc");  
                        ?>
                        <div id="dvContainer<?php echo $resultlatest[0]->id ; ?>"  class="html-content"  >
                            ...
                            <style>
                              .certificate<?php echo $resultlatest[0]->id ; ?> {
                                ...
                                @media only screen and (max-width: 600px) {
                                  .certificate<?php echo $resultlatest[0]->id ; ?> {
                                   ...
                                   .height{
                                    ...
                                    h4{
                                        font-size:10px; letter-spacing: 1px; margin-top: 5px; margin-bottom: 5px;
                                    }
                                    h5{
                            ...
                            <div class="certificate<?php echo $resultlatest[0]->id ; ?>">
                                        ...
                                        <tr>
                                            <td style="text-transform: capitalize;">
                                               ...
                                               <table style="border: 2px solid #3e3c3c;margin: auto;font-size:10px;width:100%">
                                                ...
                                                <table style="border: 2px solid #3e3c3c;padding: 8px;font-size:10px; color:black;width: 100%">
                                                    <thead>
                                                        <tr>
                                                        <?php 
                								        $i=1;
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8"> 
                                  ...
                                  <center>  &nbsp; &nbsp; &nbsp; 
                                  <a href="javascript:void(0)" id="btnPrint<?php echo $resultlatest[0]->id ; ?>"  class="print-link avoid-this btn btn-primary ">Print And Save</a> &nbsp; &nbsp; &nbsp;  
...
<script type='text/javascript'>
        ...
        jQuery(function($) { 'use strict';
            ...
            $('#btnPrint<?php echo $value->id ; ?>').on('click', function() {
                //Print ele4 with custom options
                $("#dvContainer<?php echo $value->id ; ?>").print({
                    //Use Global styles
                    globalStyles : false,
