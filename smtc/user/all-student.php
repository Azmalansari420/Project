        ...
        <a href="export_to_excel.php" class="btn btn-info btn-sm">
         ...
         <th>Duration</th>  
          ...
          if(isset($_GET['p_s']) && !empty($_GET['p_s'])){
              $gst_list = $con->all_fetch('tbl_user',array('user_add_by_id'=>$admin_id,'p_s'=>$_GET['p_s'] ),"order by id desc");
          }else{
					$gst_list = $con->all_fetch('tbl_user',array('user_add_by_id'=>$admin_id ),"order by id desc");
        }
