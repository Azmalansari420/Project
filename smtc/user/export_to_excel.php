...
$setData = '';  
$fetch_user_details = $con->all_fetch('tbl_user',array('user_add_by_id'=>$admin_id ),"order by id desc");
if(is_array($fetch_user_details) || is_object($fetch_user_details) && !empty($fetch_user_details)){
	...
	foreach ($fetch_user_details as $value) {
		...
		$value = '"' . $value->reg_id . '"' . "\t".'"' . $value->'name' . '"' . "\t".'"' . $a->name . '"' . "\t".'"' . $a->c_code . '"' . "\t".'"' . $value->father_name . '"' . "\t".'"' . $value->mother_name . '"' . "\t".'"' . $value->email . '"' . "\t".'"' . $value->mobile . '"' . "\t".'"' . $ba . '"' . "\t".'"' . $value->dob . '"' . "\t".'"' . $state . '"' . "\t".'"' . $district . '"' . "\t".'"' . $city . '"' . "\t".'"' . $value->address . '"' . "\t".'"' . $Institute . '"' . "\t".'"' . $duration . '"' . "\t".'"' . $value->join_date . '"' . "\n";  
