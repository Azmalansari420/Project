...
<td style="width:30%;"><img width="69" height="89" src="<?php e(AUP.$fs->photo);?>" style="float:right;margin-left: 30px;"></td>
</tr>
</thead>
</table>
...
<td style="width:70%;"><span style="color:#000; display:block; font-size:12px;font-weight:600;"><?php e($fs->'name');?></span></td>
</tr>
<tr>
...
<td style="width:70%;"><span style="color:#000; display:block; font-size:12px;font-weight:600;"><?php e($fs->exam_session); ?></span><span><div style="float:right; margin-top:-39px;">
<span>Seal & Sign.</span>
<br />
