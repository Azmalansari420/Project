          ...
          <form id="main-form" method="post" role="form" class="php-email-form">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6 mt-3 mt-md-0">
                  ...
                  <input type="mobile" class="form-control" name="email" id="email" required>
                </div>

                <div class="form-group mt-3 col-md-6 mt-3 ">
                  <label for="name">EMAIL ID OF APPLICANT / आवेदक की ईमेल आईडी *</label>
                  <input type="email" class="form-control" name="mobile" id="subject" required>
                </div>

                <div class="form-group mt-3 col-md-6 mt-3 ">
                  <label for="name">DATE OF BIRTH / जन्म की तारीख</label>
                  <input type="date" class="form-control" name="mobile" id="subject" required>
                </div>
                ...
                <div class="form-group mt-3 col-md-12 mt-3 ">
                  ...
                  <input type="text" class="form-control" name="mobile" id="subject" required>
                </div>
