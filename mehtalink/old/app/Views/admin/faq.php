      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            ...
            <hr />
            <div class="row">
				<div class="col-md-3"><a class="form-control btn btn-primary" href="<?=base_url('cpdadmin/faq/'.$currentpage.'');?>">List All</a></div>
...
<section class="content">
      <div class="container-fluid">
       <form action="<?=base_url("cpdadmin/faq/$currentpage");?>" method="post" enctype = "multipart/form-data">
                ...
                <table id="example1" class="table table-bordered table-striped">
				  ...
				  <td><input type="checkbox" name="check[]" class="check" value="<?php echo $values->id;?>"/> <?=$values->id;?></td>
                   ...
                   <td>
					...
					<a href="<?=base_url('cpdadmin/faq_edit/'.$values->id);?>/<?=$currentpage;?>" title="Edit" class="btn btn-primary btn-xs">Edit</a>
