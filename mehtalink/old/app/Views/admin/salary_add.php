              ...
              <!-- form start -->
                ...
                <div class="card-body">
				   ...
				   <div class="form-group">
                    ...
                    <input type="text" required class="form-control" name="address" id="exampleInputEmail1" placeholder="Enter Address">
                  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" required class="form-control" name="salary_word" id="exampleInputEmail1" placeholder="Enter Salary In Word">
                  </div>
				  <div class="form-group">
                    <label for="exampleInputEmail1">Bank Detail</label>
                    <input type="text" required class="form-control" name="bank" id="exampleInputEmail1" placeholder="Enter Bank Detail">
                  </div>
				  
				  
				  <div class="form-group">
                    <label for="exampleInputPassword1">Description</label>
					<textarea class="ckeditor" id="myEditor" name="description" cols="35" rows="20"><?php include('salary.php');?></textarea>
