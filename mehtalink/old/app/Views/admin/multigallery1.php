      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            ...
            <hr />
            <div class="row">
				<div class="col-md-3"><a class="form-control btn btn-primary" href="<?=base_url('cpdadmin/multigallery1/'.$currentpage.'');?>">List All</a></div>
...
<section class="content">
      <div class="container-fluid">
       <form action="<?=base_url("cpdadmin/multigallery1/$currentpage");?>" method="post" enctype = "multipart/form-data">
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  class="form-control" name="udf1" id="exampleInputEmail1" placeholder="Enter Unique Code">
                  </div>
			  ...
			  <input type="checkbox" id="check_all"/> &nbsp;Check All
                <table id="example1" class="table table-bordered table-striped">
				  ...
				  <td><input type="checkbox" name="check[]" class="check" value="<?php echo $values->id;?>"/> <?=$values->id;?></td>
                    ...
                    <td><?=$values->title;?></td>
					<td><img src="<?=base_url('uploads/'.$values->file.'');?>" style="max-height: 50px;"></td>
                   <td>

					<a href="<?=base_url('cpdadmin/gallry_edit/'.$values->id);?>/<?=$currentpage;?>" title="Edit" class="btn btn-primary btn-xs">Edit</a>
