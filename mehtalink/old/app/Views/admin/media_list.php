      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            ...
            <hr />
            <div class="row">
				<div class="col-md-3"><a class="form-control btn btn-primary" href="<?=base_url('cpdadmin/media_list/'.$currentpage.'');?>">List All</a></div>
				<div class="col-md-3"><a class="form-control btn btn-success" href="<?=base_url('cpdadmin/media_add/'.$currentpage.'');?>">Add New</a></div>
            </div>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <table id="example1" class="table table-bordered table-striped">
				  ...
				  <td><input type="checkbox" name="check[]" class="check" value="<?php echo $values->id;?>"/> <?=$values->id;?> <?php if($mdtp!=5){ ?> <a href="<?=base_url('public/uploads/'.$values->file.'');?>" target="_blank"><img src="<?=base_url('public/uploads/'.$values->file.'');?>" style="max-height: 50px;float:right;"></a><?php } ?></td>
                   ...
                   <td>
					...
					<a href="<?=base_url('cpdadmin/media_edit/'.$values->id);?>/<?=$currentpage;?>" title="Edit" class="btn btn-primary btn-xs">Edit</a>
