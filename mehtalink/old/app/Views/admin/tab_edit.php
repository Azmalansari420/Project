...
?>
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
		  ...
		  <div class="col-sm-12">
            ...
            <hr />
            <div class="row">
				<div class="col-md-3"><a class="form-control btn btn-primary" href="<?=base_url('cpdadmin/tab/'.$currentpage1.'');?>">List All</a></div>
				<div class="col-md-3"><a class="form-control btn btn-success" href="<?=base_url('cpdadmin/tab/'.$currentpage1.'');?>">Add New</a></div>
    ...
    <section class="content">
      <div class="container-fluid">
       <form action="<?=base_url("cpdadmin/tab_edit/$user->id");?>/<?=$currentpage1;?>" method="post" enctype = "multipart/form-data">
