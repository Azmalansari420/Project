...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form name="checkout" method="post" class="checkout row box-shadow1" action="<?=base_url('permanentaddress');?>">
<div class="row">
                            <div class="col-sm-6">
                                <p class="checkout-form">
                                    <label>SUN SIGN&nbsp;<abbr class="required" title="required">*</abbr></label>
                                    <input type="text" required class="input-text" name="as_sun2" placeholder="SUN SIGN" value="">
                                </p>
                            </div>
                            <div class="col-sm-6">
                                <p class="checkout-form">
                                    <label>MOON SIGN&nbsp;<abbr class="required" title="required">*</abbr></label>
                                    <input type="text" required class="input-text" name="as_moon2" placeholder="MOON SIGN" value="">
                                </p>
                            </div>
                            <div class="col-sm-6">
                                <p class="checkout-form">
                                    <label>TIME OF BIRTH&nbsp;<abbr class="required" title="required">*</abbr></label>
                                    <input type="text" required class="input-text" name="as_birth2" placeholder="TIME OF BIRTH" value="">
                                </p>
                            </div>
                            <div class="col-sm-6">
                                <p class="checkout-form">
                                    <label>CITY OF BIRTH&nbsp;<abbr class="required" title="required">*</abbr></label>
                                    <input type="text" required class="input-text" name="as_birth_city2" placeholder="CITY OF BIRTH" value="">
                                </p>
                            </div>
                        </div>
