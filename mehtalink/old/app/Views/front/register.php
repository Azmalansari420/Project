                     ...
                     <div class="col-xl-6 home-1-appointment-section-bg pbmit-bg-color-global">
                        <div class="home-1-appointment-section-inner-left ms-auto">
                           <div class="pbmit-heading-subheading">
                              <h2 class="pbmit-title text-white text-uppercase">Regis<em class="pbmit-heading-subheading right">ter</em></h2>
                                 ...
                                 <div class="pbmit-main-form pbmit-form-style-1">
                                    <div class="row">
									   ...
									   <div class="col-sm-12">
                                          <div class="input-group">
                                             <span class="input-item" data-name="your-name">
                                                <input type="text" required name="name" value="" size="40" aria-invalid="false" placeholder="Name*">
                                             </span>
                                          </div>
                                       </div>
									   ...
									   <div class="col-sm-12">
                                          <div class="input-group">
                                             <span class="input-item" data-name="your-email">
                                                <input type="text" required name="mobile" value="" size="40" aria-required="true" aria-invalid="false" placeholder="Phone No*.">
                                             </span>
                                          </div>
                                       </div>
									   ...
									   <div class="col-sm-12">
                                        <div class="input-group">
                                           <span class="input-item" data-name="your-email">
                                              <input type="email" required name="email" value="" size="40" aria-required="true" aria-invalid="false" placeholder="Email*">
                                           </span>
                                        </div>
                                     </div>
									  ...
									  <div class="col-sm-12">
                                       ...
                                       <div class="col-sm-12">
                                          <div class="input-button">
                                             <button type="submit" name="submit" id="submit" class="w-100 input-control input-submit pbmit-btn pbmit-btn-hover-black">Register</button>
                                          </div>
                                       </div>
                                       <div class="col-sm-12">
                                          <p><a href="<?=base_url('login');?>"><u>Login</u></a></p>
                                       </div>
                                    </div>
                                 </div>
                              </form>
