...
?>
    ...
    <form enctype="multipart/form-data" id="contact_form" name="contact_form" method="post" action="<?=base_url($currentpage);?>">
        ...
        <div class="row">
            ...
            <div class="my-form col-md-6 col-xs-6 has-success"><label>Subject</label> <input class="form-control" type="text" name="reason" placeholder="Query " maxlength="50"  /></div>
