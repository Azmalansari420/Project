...
class SubCategoryController extends Controller
{
     protected $arr_values = array(
        ...
        "upload_path"=>'upload/',
        "page_name"=>'sub-category-detail.blade.php',
        "keys"=>'id,name',
    ...
    public function load_data(Request $request)
    {
      ...
      $data_list = SubCategory::where([$this->arr_values['table_name'].'.status' => $status])->orderBy('id',$order_by)
    ...
    public function update(Request $request)
    {
        ...
        if(empty($id)) $data = new SubCategory;
        else $data = SubCategory::find($id);
