...
<div class="app-menu navbar-menu">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('category.list')); ?>">
                                <i class="ri-product-hunt-line"></i> <span data-key="t-dashboards">Videos</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('category.list')); ?>">
        ...
        <!-- Left Sidebar End --><?php /**PATH D:\xamp\htdocs\projects\codediffusion\hindibible\resources\views/admin/headers/header.blade.php ENDPATH**/ ?>