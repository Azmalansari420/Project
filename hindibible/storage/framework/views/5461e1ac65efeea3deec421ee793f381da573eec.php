                                ...
                                <div class="card">
                                    <div class="card-body frm">
                                        <div class="row">                                            
                                            ...
                                            <div class="col-lg-4">
                                                <label class="form-label" for="product-title-input">Payout Pin</label>
                                                <input type="text" class="form-control" placeholder="Enter Payout Pin" name="payoutpin" value="<?php echo e(@$form_data->pin); ?>" required>
                                            </div>                                            
...
</html><?php /**PATH D:\xamp\htdocs\projects\codediffusion\hindibible\resources\views/admin/setting/payoutpin-form.blade.php ENDPATH**/ ?>