                                    ...
                                    <div class="card card-animate p-0">
                                        <div class="card-body row" >
                                            <div class="col-md-6" style="margin: 0 auto;">
                                                <div class="row">                                            
                                                    <div class="col-md-3">
                                                        <input type="date" class="form-control" name="from_date" value="<?php echo e(date('Y-m-d', strtotime($from_date))); ?>">
                                                    </div>
                                                    <div class="col-md-3" >
                                                        <input type="date" class="form-control" name="to_date" value="<?php echo e(date('Y-m-d', strtotime($to_date))); ?>">
                                                    </div>
                                                    <div class="col-md-3" >
                                                    ...
                                                    <div class="col-md-3" >
                                                        <a href="<?php echo e(url('set_incomes')); ?>" class="btn btn-primary">Set Income</a>
                                                    </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><?php echo e(\App\Helper\Helpers::currency_simble()); ?> <span class="counter-value" data-target="<?php echo e($total_paybele_amount); ?>" id="total_paybele_amount">0</span> </h4>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <span class="avatar-title bg-success-subtle rounded fs-3">
                                                            <i class="bx bx-dollar-circle text-success"></i>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><?php echo e(\App\Helper\Helpers::currency_simble()); ?> <span class="counter-value" data-target="<?php echo e($total_paid_amount); ?>" id="total_paid_amount">0</span> </h4>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <span class="avatar-title bg-success-subtle rounded fs-3">
                                                            <i class="bx bx-dollar-circle text-success"></i>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><?php echo e(\App\Helper\Helpers::currency_simble()); ?> <span class="counter-value" data-target="<?php echo e($profit_loss); ?>" id="profit_loss">0</span> </h4>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <span class="avatar-title bg-success-subtle rounded fs-3">
                                                            <i class="bx bx-dollar-circle text-success"></i>
                                    ...
                                    <div class="col-xl-3 col-md-6 hide">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><?php echo e(\App\Helper\Helpers::currency_simble()); ?> <span class="counter-value" data-target="<?php echo e($all_time_gst); ?>" id="all_time_gst">0</span></h4>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    ...
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                                        <?php ($users = DB::table("users")
                                                            ...
                                                            ->where('is_paid',1)
                                                            ->count()); ?>
                                                        <span class="counter-value" data-target="<?php echo e($users); ?>"><?php echo e($users); ?></span>
                                                    </h4>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
...
</html><?php /**PATH D:\xamp\htdocs\projects\tanjeem\jinnuncle\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>