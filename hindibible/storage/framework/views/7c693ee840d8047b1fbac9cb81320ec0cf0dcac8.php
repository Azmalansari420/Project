                        ...
                        <div class="col-lg-12">
                            <div class="card" id="applicationList">
                                <div class="card-header  border-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <select class="form-control invoice" id="invoicechange">
                                        ...
                                        <div class="col-md-3">
                                         ...
                                         <div class="col-md-4">
                                            <select class="form-control searchtype" id="searchtype">
                                               <option value="">All Types</option>
                                               <option value="1">Name</option>
                                               <option value="2">Email</option>
                                               <option value="3">Phone</option>
                                               <option value="4">Affiliate ID</option>
...
<script>
   ...
   function get_url_data()
   {
       ...
       var order_type = $("#invoicechange").val();
       var status = $("#statuschange").val();
       var order_by = $("#order_by").val();
       var limit = $("#limit").val();
       var filter_search_value = $(".search-input").val();
       data = `searchtype=${searchtype}&order_type=${order_type}&status=${status}&order_by=${order_by}&limit=${limit}&filter_search_value=${filter_search_value}`;
   }
   get_url_data()
   url = main_url+'?'+data;
   load_table();
   $(document).on("change", "#statuschange, #invoicechange, .order_by, .limit",(function(e) {
      get_url_data();
      url =main_url+"?"+data;
      load_table();
   }));
...
</html><?php /**PATH /home/u346521377/domains/digitalnamo.com/public_html/azmal/2025/april/hindibible/resources/views/admin/invoice/index.blade.php ENDPATH**/ ?>