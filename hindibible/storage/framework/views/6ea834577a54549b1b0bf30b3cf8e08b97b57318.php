...
<div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="<?php echo e(url('/')); ?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(url('public')); ?>/assetsadmin/images/favicon.png" alt="" >
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(url('public')); ?>/assetsadmin/images/logo.png" alt="" >
                    </span>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="#sidebarTabs" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarTabs" data-key="t-projects">
                                <i class="ri-question-line"></i>Tabs
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarTabs">
                                <ul class="nav nav-sm flex-column">


                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('category.list')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">Category</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('sub-category.list')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">Sub Category</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('sub-sub-category.list')); ?>">
                                            <i class="ri-file-copy-line"></i> <span data-key="t-dashboards">Sub Sub Category</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('sub-sub-sub-category.list')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">Sub Sub Sub Category</span>
                                        </a>
                                    </li> 
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('post.list')); ?>">
                                <i class="ri-product-hunt-line"></i> <span data-key="t-dashboards">Post</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('expression-image.list')); ?>">
                                <i class="ri-product-hunt-line"></i> <span data-key="t-dashboards">Expression Images</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('category.list')); ?>">
                                <i class="ri-product-hunt-line"></i> <span data-key="t-dashboards">Sub Admin</span>
                            </a>
                        </li>
        ...
        <!-- Left Sidebar End --><?php /**PATH /home/u346521377/domains/digitalnamo.com/public_html/azmal/2025/april/hindibible/resources/views/admin/headers/header.blade.php ENDPATH**/ ?>