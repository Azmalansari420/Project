                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <select class="form-select mb-3" aria-label="Default select example" name="post_type">
                                                    ...
                                                    <option value="1" @if(!empty(@$row) && @$row->post_type==1)selected @endif >Video</option>
                                                    <option value="2" @if(!empty(@$row) && @$row->post_type==2)selected @endif >Audio</option>
                                                    <option value="3" @if(!empty(@$row) && @$row->post_type==3)selected @endif >Image</option>
                                                    <option value="4" @if(!empty(@$row) && @$row->post_type==4)selected @endif >Content</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <select class="form-control" name="category_id" data-href="" data-target="#sub-category" id="category" required>
                                                    ...
                                                    @if(!empty($category))
                                                        <option value="{{@$row->category_id}}"  selected >{{$category->name}}</option>
                                                    @endif                                                    
                                                </select>
                                            </div>
