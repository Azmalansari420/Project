                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-12">
                                                    <input class="form-control upload-single-image" type="file" name="webinar_banner" data-target="webinar_banner">
                                                    <img class="upload-img-view img-thumbnail mt-2 mb-2 webinar_banner" id="viewer"
                                                    onerror="this.src='{{asset('storage/app/public/upload/default.jpg')}}'"
                                                    src="{{asset('storage/app/public/upload/')}}/{{@$form_data->webinar_banner}}" alt="banner image"/>
                                                </div>
                                            </div>
