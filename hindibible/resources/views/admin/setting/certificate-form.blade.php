                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-12">
                                                    <input class="form-control upload-single-image" type="file" name="certificate_banner" data-target="certificate_banner">
                                                    <img class="upload-img-view img-thumbnail mt-2 mb-2 certificate_banner" id="viewer"
                                                    onerror="this.src='{{asset('storage/app/public/upload/default.jpg')}}'"
                                                    src="{{asset('storage/app/public/upload/')}}/{{@$form_data->certificate_banner}}" alt="banner image"/>
                                                </div>
                                            </div>
