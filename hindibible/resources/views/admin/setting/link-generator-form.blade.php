                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-12">
                                                    <input class="form-control upload-single-image" type="file" name="link_generator_banner" data-target="link_generator_banner">
                                                    <img class="upload-img-view img-thumbnail mt-2 mb-2 link_generator_banner" id="viewer"
                                                    onerror="this.src='{{asset('storage/app/public/upload/default.jpg')}}'"
                                                    src="{{asset('storage/app/public/upload/')}}/{{@$form_data->link_generator_banner}}" alt="banner image"/>
                                                </div>
                                            </div>
