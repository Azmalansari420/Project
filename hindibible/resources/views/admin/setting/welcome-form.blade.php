                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-12">
                                                    <textarea class="form-control" name="welcome_banner" row="5">{{@$form_data->welcome_banner}}</textarea>
                                                    @if(!empty(@$form_data->welcome_banner))
                                                        <iframe class="mt-2" width="100%" height="315" src="https://www.youtube.com/embed/{{@$form_data->welcome_banner}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                    @endif
                                                </div>
                                            </div>
