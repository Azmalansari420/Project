                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-12">
                                                    <input class="form-control upload-single-image" type="file" name="offer_banner" data-target="offer_banner">
                                                    <img class="upload-img-view img-thumbnail mt-2 mb-2 offer_banner" id="viewer"
                                                    onerror="this.src='{{asset('storage/app/public/upload/default.jpg')}}'"
                                                    src="{{asset('storage/app/public/upload/')}}/{{@$form_data->offer_banner}}" alt="banner image"/>
                                                </div>
                                            </div>
