                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Enter Font Size" name="font_size" value="{{@$row->font_size}}" required>
                                            </div>

                                            <div class="col-lg-6 hide">
                                                <label class="form-label" for="product-title-input">Font Color</label>
                                                <input type="color" class="form-control" placeholder="Enter Font Color" name="font_color" value="{{@$row->font_color}}" >
                                            </div>
