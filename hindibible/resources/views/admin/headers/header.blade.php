...
<div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{url('/')}}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{url('public')}}/assetsadmin/images/favicon.png" alt="" >
                    </span>
                    <span class="logo-lg">
                        <img src="{{url('public')}}/assetsadmin/images/logo.png" alt="" >
                    </span>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarTabs">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="{{route('sub-category.list')}}">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">Sub Category</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="{{route('sub-sub-category.list')}}">
                                            <i class="ri-file-copy-line"></i> <span data-key="t-dashboards">Sub Sub Category</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="{{route('sub-sub-sub-category.list')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{route('post.list')}}">
                                <i class="ri-product-hunt-line"></i> <span data-key="t-dashboards">Post</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{route('expression-image.list')}}">
