...
<section class="splide" aria-labelledby="carousel-heading">
        <h2 id="carousel-heading mt-3 mb-3 text-center">Our Video</h2>
        ...
        <div class="splide__track mt-4 mb-5">
            <ul class="splide__list">
                ...
                <li class="splide__slide">
                   <video src="<?=base_url() ?>media/uploads/videos/<?=$data->image ?>" controls autoplay width="100%"></video>
                </li>
                <?php } ?>
...
<style>
    .marwuee-bottom{
        ...
        background: linear-gradient(310deg, rgba(251, 17, 17, 0.86) 15%, rgba(249, 132, 33, 0.77) 100%);
        text-size: 30px; 
        text-size-mb: 20px;
        gap-blocks: 10.0px; 
        border-color: #232323; 
