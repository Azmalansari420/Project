                                 ...
                                 <div class="col-lg-6 mb-3">
                                    <div class="mb-lg-0 mb-3">
                                       ...
                                       <select class="form-select" name="vendor_id"  required>
                                          ...
                                          $categories = $this->crud->selectDataByMultipleWhere('tbl_admin',array('status'=>1,'role'=>2,));
                                          foreach($categories as $data)
                                             { ?>
                                          <option <?php if($EDITDATA[0]->vendor_id==$data->id) echo 'selected'; ?> value="<?php echo $data->id; ?>" ><?php echo $data->first_name; ?></option>
                                          <?php } ?>
                                       </select>
                                    </div>
                                 </div>
