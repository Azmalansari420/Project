<input type="hidden" name="imagessec[]" value="<?=$i ?>">
...
<li class="row" style="margin-top: 25px;">
	...
	<div class="col-lg mb-3">
       <div class="mb-lg-0 mb-3">
          ...
          <select class="form-select chzn-color" name="color_id<?=$i ?>[]" multiple>
            <?php 
            ...
            foreach($color as $data)
                {
                    ...
                    {                        
                        if(in_array($data->id, $all_images->color_id))
                            $selected = 'selected';
                    }
                 ?>
	...
	<div class="col-lg mb-3">
       <div class="mb-lg-0 mb-3">
          ...
          <select class="form-select chzn-size" name="size_id<?=$i ?>[]" multiple>
             <?php 
