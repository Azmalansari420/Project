                        ...
                        <table id="data-table-buttons" class="table table-striped table-bordered align-middle">
                           ...
                           <tbody>
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td>
                                    <img src="<?php echo base_url($upload_path); ?><?php echo $data->thumb_img; ?>" class="rounded h-60px my-n1 mx-n1"/>
                                 </td>
                                 <td class=""><?php if(!empty($vendor[0]->first_name)){ echo $vendor[0]->first_name;}else { echo 'Select First';} ?></td>
