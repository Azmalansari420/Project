                        ...
                        <table id="data-table-buttons" class="table table-striped table-bordered align-middle">
                           ...
                           <tbody>
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td>Shipment ID:- <?=$data->shipment_id ?><br>
                                    Channel Order ID:- <?=$data->channel_order_id ?>
                                 </td>
                                 ...
                                 <td><?php echo paymenttype($data->payment_method); ?></td>
                              
                                 <td class="">
                                    <form method="post" action="<?php echo base_url('admin_con/finalorder/status_change'); ?>" enctype="multipart/form-data">
                                       <input type="hidden" name="id" value="<?=$data->id ?>">
                                       <select class="form-select mb-2" name="status">
                                          <option value="0" <?php if($data->status==0)echo'selected'; ?>>Not Paid</option>
                                          <option value="1" <?php if($data->status==1)echo'selected'; ?>>Confirm Order</option>
                                          ...
                                          <option value="6" <?php if($data->status==6)echo'selected'; ?>>Exchange Request</option>
                                          <option value="7" <?php if($data->status==7)echo'selected'; ?>>Accept Exchange Request</option>
                                          <option value="8" <?php if($data->status==8)echo'selected'; ?>>Cancel Exchange Request</option>
                                       </select>
                                       <!-- <br> -->
