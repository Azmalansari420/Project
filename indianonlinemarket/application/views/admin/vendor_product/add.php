 ...
 -->
                        ...
                        <div class="tab-pane fade" id="default-tab-2">
                           <div class="card border-0 mb-4">
                              <div class="card-header h6 mb-0 bg-none p-3">
                                 <i class="fa fa-fa fa-lg fa-fw text-dark text-opacity-50 me-1"></i> Upload Image (<a href="https://www.imagesmaller.com/" target="_blank">Click to Reduce image file size of up to 90% without losing quality</a>)
                              </div>
                              <div class="card-body">
                                 <div class="row">
                                    <div class="col-lg-6 mb-4">
