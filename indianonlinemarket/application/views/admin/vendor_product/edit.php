                     ...
                     <div class="tab-content panel rounded-0 p-3 m-0">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-6 mb-4">
                                    <div class="mb-lg-0 mb-3">
                                       ...
                                       <input type="number" class="form-control" name="rating"  value="<?php echo $EDITDATA[0]->rating; ?>">
                                    </div>
                                 </div>
                        ...
                        <div class="tab-pane fade" id="default-tab-2">
                           <div class="card border-0 mb-4">
                              <div class="card-header h6 mb-0 bg-none p-3">
                                 <i class="fa fa-fa fa-lg fa-fw text-dark text-opacity-50 me-1"></i> Upload Image Upload Image (<a href="https://www.imagesmaller.com/" target="_blank">Click to Reduce image file size of up to 90% without losing quality</a>)
                              </div>
                              <div class="card-body">
                                 <div class="row">
 ...
 <script >
   ...
   <script>
    ...
    $(document).on("click", "#add-more-btn",(function(e) {
        ...
        var html =  ``;
        $.ajax({
        url : "<?php echo base_url('admin_con/vendor_product/addmore_image'); ?>",
        method : "POST",
        data : {i:i},
   ...
   <script>
           function get_sub_category()
           {
              ...
              $.ajax({
                    dataType:"json",
                    url:"<?php echo base_url('admin_con/vendor_product/sub_categ'); ?>",
                    method: "post",
                    data:{id:id},
                    success: function(data)
                    {
