                        ...
                        <table id="data-table-buttons" class="table table-striped table-bordered align-middle">
                           <thead>
                              <tr>
                                 ...
                                 <th class="text-nowrap">Show iN Menu</th>
                           ...
                           <tbody>
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td >
                                    <img src="<?php echo base_url($upload_path.$data->image); ?>" class="rounded h-60px my-n1 mx-n1" />
                                 </td>
                                 <td class=""><?php echo $data->name; ?></td>
                                 <td class=""><?php echo show_home($data->show_menu); ?></td>
