                           ...
                           <tbody>
                              ...
                              foreach ($ALLDATA as $key => $data) 
                                 {  $i++;
                                    ...
                                    $allimage = $this->crud->selectDataByMultipleWhere('all_images',array('p_id'=>$data->p_id,'color_id'=>$data->color_id,'size_id'=>$data->size_id,));
                                 ?>
                              <tr class="odd gradeX">
                                 ...
                                 <td>
                                    Name:- <?php echo $finalorder->firstname; ?> <?php echo $finalorder->lastname; ?>  <br>
                                    Email:- <?php echo $finalorder->email; ?><br>
                                    Mobile:- <?php echo $finalorder->mobile; ?><br>
                                 </td>
                                 <td>₹ <?php echo number_format($allimage[0]->price,2); ?></td>
                                 <td><?php echo paymenttype($finalorder->payment_method); ?></td>
