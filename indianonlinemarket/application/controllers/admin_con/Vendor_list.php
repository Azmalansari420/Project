...
class Vendor_list extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'load_path'=>'admin/vendor_list/',
						   	'redirect_path'=>'admin_con/vendor_list/',
						   	'back_url'=>'vendor_list',
						   	'add_url'=>'vendor_list',
						   	'edit_url'=>'vendor_list',
						   	'delete_url'=>'vendor_list',
						   	'view_url'=>'vendor_list',
						   	'status_value'=>'vendor_list',
						   	'multiple_delete'=>'admin_con/vendor_list/delete_all',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$check_username = $this->crud->selectDataByMultipleWhere($this->arr_values['table_name'],array('username'=>$username,));
			...
			{
				$this->session->set_flashdata('message','<div class="toast show" role="alert" aria-live="assertive" aria-atomic="true"><div class="toast-header"><div class="bg-blue rounded w-25px h-25px d-flex align-items-center justify-content-center text-white"><i class="fa fa-bell"></i></div><strong class="me-auto ms-2">Message</strong><button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button></div><div class="toast-body" style="color:black;">Username Already Exits..</div></div>');			
