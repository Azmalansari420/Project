...
class Vendor_order extends CI_Controller
{
	...
	protected $arr_values = array(
						   	'page_title'=>'Orders',
						   	'table_name'=>'orders',
						   	'upload_path'=>'media/uploads/vendor_order/',
						   	'load_path'=>'admin/vendor_order/',
						   	'redirect_path'=>'admin_con/vendor_order/',
						   	'back_url'=>'vendor_order',
						   	'add_url'=>'vendor_order',
						   	'edit_url'=>'vendor_order',
						   	'invoice_url'=>'vendor_order',
						   	'delete_url'=>'vendor_order',
						   	'view_url'=>'vendor_order',
						   	'status_value'=>'vendor_order',
						   ); 
   ...
   //--check user login or not
	...
	function listing()
	{
		...
		$data['ALLDATA'] = $this->crud->selectDataByMultipleWhere($this->arr_values['table_name'],array('vendor_id'=>$this->session->userdata('id'),));
