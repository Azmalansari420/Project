...
class Admin_vendor_ticket extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'Vendor Ticket',
						   	'table_name'=>'vendor_ticket',
						   	'upload_path'=>'media/uploads/admin_vendor_ticket/',
						   	'load_path'=>'admin/admin_vendor_ticket/',
						   	'redirect_path'=>'admin_con/admin_vendor_ticket/',
						   	'back_url'=>'admin_vendor_ticket',
						   	'add_url'=>'admin_vendor_ticket',
						   	'edit_url'=>'admin_vendor_ticket',
						   	'delete_url'=>'admin_vendor_ticket',
						   	'view_url'=>'admin_vendor_ticket',
						   	'status_value'=>'admin_vendor_ticket',
						   	'multiple_delete'=>'admin_con/admin_vendor_ticket/delete_all',
						   ); 
   ...
   //--check user login or not
	...
	function edit()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$data['admin_reply'] = $this->input->post('admin_reply');			
			$data['status'] = $this->input->post('status');						
