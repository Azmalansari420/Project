								...
								<table id="example2" class="table table-striped table-bordered" style="width:100%">
									...
									<tbody>
										...
										<td><span class="badge badge-primary"> $ <?php echo $pro->cpi;?></span></td>
											...
											<td>
												<a data-toggle="modal" data-target="#urls" class="urls" data1="<?php echo $pro->uid;?>" data2="<?php echo $pro->pid;?>">
...
$(document).ready(function() {
        ...
        $('.urls').on('click', function() {
            ...
            var pid = $(this).attr('data2');
                ...
                var url1="<?php echo base_url();?>status?return=complete&pid="+pid+"&uid=XXX";
				var url2="<?php echo base_url();?>status?return=terminate&pid="+pid+"&uid=XXX";
				var url3="<?php echo base_url();?>status?return=quotafull&pid="+pid+"&uid=XXX";
