				...
				<div class="page-content">
					...
					<div class="card">
						<div class="card-body">
							...
							<?php echo form_open(base_url( 'employee/all_reports' ), array( 'id' => 'password', 'class' => 'password', 'method' => 'post', 'autocomplete'=>'off'));?>
							...
							<div class="form-row">
											...
											<div class="form-group col-md-3">
												<label>UID</label>
												<input type="number" name="uid" class="form-control  " value="<?php echo $uid;?>" />
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-3">
