							...
							<div class="card-deck flex-column flex-lg-row">
								<div class="card radius-15 bg-info">
									<div class="card-body text-center">
										...
										<h4 class="mb-0 font-weight-bold mt-3 text-white"><?php echo $this->emp_model->get_total_project();?></h4>
								...
								<div class="card radius-15 bg-wall">
									<div class="card-body text-center">
										...
										<h4 class="mb-0 font-weight-bold mt-3 text-white"><?php echo $this->emp_model->get_total_comproject();?></h4>
								...
								<div class="card radius-15 bg-rose">
									<div class="card-body text-center">
										...
										<h4 class="mb-0 font-weight-bold mt-3 text-white"><?php echo $this->emp_model->get_total_uncomproject();?></h4>
						...
						<div class="row no-gutters row-group">
								...
								<div class="card-body">
									<div class="media align-items-center">
										<div class="media-body">
											<h4 class="mb-0 font-weight-bold text-info"><?php echo $this->emp_model->get_total_sur();?></h4>
							...
							<div class="col-12 col-lg-3">
								<div class="card-body">
									<div class="media align-items-center">
										<div class="media-body">
											<h4 class="mb-0 font-weight-bold text-facebook"><?php echo $this->emp_model->get_total_comsur();?></h4>
							...
							<div class="col-12 col-lg-3">
								<div class="card-body">
									<div class="media align-items-center">
										<div class="media-body">
											<h4 class="mb-0 font-weight-bold text-youtube"><?php echo $this->emp_model->get_total_termsur();?></h4>
							...
							<div class="col-12 col-lg-3">
								<div class="card-body">
									<div class="media align-items-center">
										<div class="media-body">
											<h4 class="mb-0 font-weight-bold text-linkedin"><?php echo $this->emp_model->get_total_quotasur();?></h4>
