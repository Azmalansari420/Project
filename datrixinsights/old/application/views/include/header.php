...
<head>
	...
	<!--favicon-->
	<link rel="icon" href="<?php echo base_url();?>assets/images/logo-icon.png" type="image/png" />
	<!-- Vector CSS -->
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			?>
				...
				<li>
					...
					<ul>
						<li> <a href="<?php echo base_url();?>admin/add_employee"><i class="bx bx-right-arrow-alt"></i>Add New Employee</a>
						</li>
						<li> <a href="<?php echo base_url();?>admin/all_employee"><i class="bx bx-right-arrow-alt"></i>All Employee</a>
						</li>
						<li> <a href="<?php echo base_url();?>admin/all_approved_employee"><i class="bx bx-right-arrow-alt"></i>Approved Employee</a>
						</li>
						<li> <a href="<?php echo base_url();?>admin/all_unapproved_employee"><i class="bx bx-right-arrow-alt"></i>Unapproved Employee</a>
						</li>
				...
				<li>
					...
					<ul>
						<li> <a href="<?php echo base_url();?>admin/add_partners"><i class="bx bx-right-arrow-alt"></i>Add New Partner</a>
						</li>
						<li> <a href="<?php echo base_url();?>admin/all_partners"><i class="bx bx-right-arrow-alt"></i>All Partners</a>
						</li>
				...
				<li>
					...
					<ul>
					<li> <a href="<?php echo base_url();?>admin/add_new_project"><i class="bx bx-right-arrow-alt"></i>Add Project</a>
						</li>
						<li> <a href="<?php echo base_url();?>admin/all_project"><i class="bx bx-right-arrow-alt"></i>All Projects</a>
						</li>
						<li> <a href="<?php echo base_url();?>admin/active_project"><i class="bx bx-right-arrow-alt"></i>Active Projects</a>
						</li>
				...
				<li>
					...
					<ul>
						<li> <a href="<?php echo base_url();?>admin/all_reports"><i class="bx bx-right-arrow-alt"></i>All Reports</a>
						</li>
						<li> <a href="<?php echo base_url();?>admin/summary_reports"><i class="bx bx-right-arrow-alt"></i>Summary Reports</a>
						</li>
				...
				<li>
					...
					<ul>
						<li> <a href="<?php echo base_url();?>admin/all_admins"><i class="bx bx-right-arrow-alt"></i>All Admins</a>
						</li>
...
<li>
					<a href="<?php echo base_url();?>admin/all_project">
						<div class="parent-icon icon-color-1"><i class="bx bx-home-alt"></i>
						</div>
						...
						<li class="nav-item dropdown dropdown-user-profile">
							<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-toggle="dropdown">
								<div class="media user-box align-items-center">
									...
									<img src="<?php echo base_url('upload/'.$this->session->userdata('image'));?>" class="user-img" alt="user avatar">
								</div>
							</a>
							<div class="dropdown-menu dropdown-menu-right">	<a class="dropdown-item" href="<?php echo base_url();?>admin/profile"><i
										class="bx bx-user"></i><span>Profile</span></a>
								
								<div class="dropdown-divider mb-0"></div>	<a class="dropdown-item" href="<?php echo base_url();?>admin/logout"><i
