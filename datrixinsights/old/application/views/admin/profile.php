                                   ...
                                   <div class="card-body page-title-box">
                                       ...
                                       <div class="tab-content p-3 text-muted">
                                           <div class="tab-pane active" id="home1" role="tabpanel">
                                               <div class="row">
                                                  <div class="col-md-6">
                                                    <div class="row">
                                                      <div class="col-md-4">
                                                        <p class="profile-logo"><?php echo substr($this->session->userdata('username'),0,1)?></p>
                                                        <h4><?php echo $this->session->userdata('username');?></h4>
                                                      </div>
                                                      <div class="col-md-8">
                                                        <table class="table table-striped mb-0">
                                                           <tr>
                                                              <td>User Name</td><td> <?php echo $profile->username;?></td>
                                                           </tr>
                                                           <tr>
                                                           ...
                                                           <tr>
                                                              <td>Role</td><td> <?php echo $profile->role;?></td>
                                                           </tr>
                                                           <tr>
                                                              <td>Status</td><td> <span class="badge badge-success">Active</span></td>
                                                           </tr>
                                                        </table>
                                                      </div>
                                                  </div>
                                           ...
                                           <div class="tab-pane" id="profile1" role="tabpanel">
                                               <?php echo form_open(base_url( 'admin/admin/profile_update' ), array( 'id' => 'profile', 'class' => 'profile', 'method' => 'post', 'autocomplete'=>'off'));?>
                                               <p class="mb-0">
                                                <div class="row">
                                                   <div class="col-md-12">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" name="username" type="text" value="<?php echo $profile->username;?>" id="example-text-input">
                                            </div>
                                        </div>
                                                   </div>
                                                   <div class="col-md-12">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control emailchanger" name="email" type="text" value="<?php echo $profile->email;?>" id="email-changed">
                                                 <p class="badge badge-warning email-change-msg">You must verify this email id before update email</p>
                                            </div>
                                          </div>
                                                   </div>
                                                   <div class="col-md-12">
                                            ...
                                            <div class="col-md-10 code-verify">
                                               <input type="button" class="btn btn-success" value="SEND VERIFICATION CODE" style="float:left;" />
                                               <input type="text" placeholder="Enter varification code"  class="form-control col-md-4 offset-md-1 codematch textcodematch" style="float:left;"/>
                                               <input type="button" class="btn btn-primary codematch offset-md-1 btncodematch" value="VERIFY" style="float:left;"/>
                                          </div>
                                          </div>
                                                   </div>
                                           ...
                                           <div class="tab-pane" id="messages1" role="tabpanel">
                                             <?php echo form_open(base_url( 'admin/password_change' ), array( 'id' => 'password', 'class' => 'password', 'method' => 'post', 'autocomplete'=>'off'));?>
                                             <p class="mb-0">
                                              <div class="row">
                                                 <div class="col-md-12">
                                                   <div class="form-group row">
