...
class Service_booking extends CI_Controller
{
	...
	protected $arr_values = array(
						   	'page_title'=>'Enquiry',
						   	'table_name'=>'service_booking',
						   	'upload_path'=>'media/uploads/service_booking/',
						   	'load_path'=>'admin/service_booking/',
						   	'redirect_path'=>'admin_con/service_booking/',
						   	'back_url'=>'service_booking',
						   	'edit_url'=>'service_booking',
						   	'delete_url'=>'service_booking',
						   	'view_url'=>'service_booking',
						   	'status_value'=>'service_booking',
						   	'multiple_delete'=>'admin_con/service_booking/delete_all',
						   );
