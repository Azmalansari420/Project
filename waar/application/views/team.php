...
/*        height: 249px;*/
    ...
    padding: 20px 20px;
     ...
     <div class="testimonial-one-wrapper padd-100 float-start w-100">
        <div class="section-heading animated wow fade-up">
            <h4 style="    color: #911439;">Our Team</h4>
        </div>
        <div class="container">
            <div class="row">
                <?php
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                    <div class="testimonial-one animated wow fade-box">
                        <a href="<?=base_url('team-details/'.$data->slug) ?>">
                            <div class="test-img">
                                <img src="<?=base_url() ?>media/uploads/team/<?=$data->image ?>" alt="image" class="img-fluid">
                            </div>
