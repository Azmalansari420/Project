...
/*            left: 84px;*/
    ...
    <div class="inner-page-wrapper float-left" style="background-image: url(<?=base_url() ?>media/team.jpeg);">
            ...
            <div class="row fade-up">
                <div class="col-lg-4 col-md-12 col-sm-12 col-12 text-center">
                    <div class="about-img mt-lg-0 mt-md-4 mt-4">
                        <span>
                            <img src="<?=base_url() ?>media/uploads/team/<?=$EDITDATA[0]->image ?>" alt="img" class="img-fluid w-75">
                        </span>
                    </div>
                </div>
