...
/*            left: 84px;*/
    ...
    <div class="inner-page-wrapper float-left" style="background-image: url(<?=base_url() ?>images/service.jpeg);">
        <div class="inner-head">
            <h1 class="header-class"><?=$EDITDATA[0]->name ?></h1>
            <!-- <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="<?=base_url() ?>" style="color: black;">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page" style="color: black;"><?=$EDITDATA[0]->name ?></li>
                </ol>
            </nav> -->
        </div>
    </div>
        ...
        <div class="container">
            <div class="row fade-up">
                <div class="col-lg-6 col-md-12 col-sm-12 col-12 text-center">
                    ...
                    <div class="about-content py-0 mobile-none">
                        <h3><?=$data->name ?></h3>
                    </div>
                    <div class="about-img mt-lg-0 mt-md-4 mt-4">
                        <span>
                            <img src="<?=base_url() ?>media/uploads/services/<?=$data->image ?>" alt="img" class="img-fluid w-75">
                        </span>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="about-content py-0">
                        <h3 class="mobile-show"><?=$data->name ?></h3>
                        <p class="mt-4"><?=$data->content ?></p>
                        <div class="about-btn-page">
                            <a href="<?=base_url() ?>appointment" class="main-btn-red">
                                <em><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i></em><span>Make An Appointment
                                </span>
                            </a>
                        </div>
                    </div>
