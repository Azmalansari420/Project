...
function book_type($value)
{
  if($value==2)
  {
    $string = '<button class="btn btn-primary btn-sm">Book Appointment</button>';
  }

  else if($value==1)
  {
    $string = '<button class="btn btn-danger btn-sm">EMERGENCY APPOINTMENT</button>';
  }
