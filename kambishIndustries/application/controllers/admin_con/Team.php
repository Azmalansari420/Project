...
class Team extends CI_Controller
{
	...
	protected $arr_values = array(
						   	'page_title'=>'Team',
						   	'table_name'=>'team',
						   	'upload_path'=>'media/uploads/team/',
						   	'load_path'=>'admin/team/',
						   	'redirect_path'=>'admin_con/team/',
						   	'back_url'=>'team',
						   	'add_url'=>'team',
						   	'edit_url'=>'team',
						   	'delete_url'=>'team',
						   	'view_url'=>'team',
						   	'table_url'=>'admin/team/table',
						   	'status_value'=>'team',
						   	'multiple_delete'=>'admin_con/team/delete_all',
						   	'pagination_url'=>'admin_con/team/get_table_data',
						   	'controller_name'=>'team',
						   	'page_name'=>'team.php',
						   	'pagination_limit'=>'15',
						   	'formURL'=>'admin_con/team/UpdateData',
						   ); 
   ...
   //--check user login or not
    ...
    function UpdateData()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$orderline = $this->input->post('orderline');			
