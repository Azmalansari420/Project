...
<sidebar id="sidebar" class="app-sidebar">
   <div data-scrollbar="true" data-height="100%">
      <ul class="nav">
         ...
         <li class="<?php if($currentURL==base_url('admin_con/content/edit/1')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/content/edit/1'); ?>">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
         ...
         <li class="<?php if($currentURL==base_url('admin_con/team/listing')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/team/listing');?>">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
