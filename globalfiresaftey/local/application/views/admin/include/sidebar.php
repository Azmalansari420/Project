...
<sidebar id="sidebar" class="app-sidebar">
   <div data-scrollbar="true" data-height="100%">
      <ul class="nav">
         ...
         <li class="<?php if($currentURL==base_url('admin_con/testimonials/listing')) echo 'active'; ?>">
         ...
         <li class="has-sub">
            ...
            <ul class="nav-submenu">
               ...
               <li class="<?php if($currentURL==base_url('admin_con/content/edit/4')) echo 'active'; ?>"><a href="<?php echo base_url('admin_con/content/edit/4'); ?>"><span class="nav-text">Home Page About us</span></a>
               </li>
               <li class="<?php if($currentURL==base_url('admin_con/content/edit/5')) echo 'active'; ?>"><a href="<?php echo base_url('admin_con/content/edit/5'); ?>"><span class="nav-text">Bottom Content</span></a>
               </li>
            </ul>
         </li>
