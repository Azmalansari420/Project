              ...
              <div class="contact-wrapper">
                <div class="contact-box fade-anim">
                  <div class="contact-text">
                    ...
                    <p class="text">500 Suite San Francisco, CA 94105, USA</p>
                  </div>
                </div>
                <div class="contact-box fade-anim">
                  <div class="contact-text">
                    <div class="link"><a href="mailto:info@synvo.com">info@synvo.com</a></div>
                    <p class="text">Email us anytime for any kind of query.</p>
                  </div>
                </div>
                <div class="contact-box fade-anim">
                  <div class="contact-text">
                    <div class="link">Hotline: <a href="tel:+1(415)555-0123">+1 (415) 555-0123</a></div>
