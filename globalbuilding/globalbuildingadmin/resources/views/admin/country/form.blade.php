               ...
               <div class="col-lg-8">
                  <div class="card m-b-15">
                     <div class="row card-body">
                        ...
                        <div class="col-6 form-group">
                           <label>ISO </label>
                           <input type="text" class="form-control" name="iso" value="{{@$EDITDATA->iso}}">
                        </div>
                        <div class="col-6 form-group">
                           <label>Num Code </label>
                           <input type="text" class="form-control" name="numcode" value="{{@$EDITDATA->numcode}}">
                        </div>

                        <div class="col-6 form-group">
                           <label>Phone Code </label>
                           <input type="text" class="form-control" name="phonecode" value="{{@$EDITDATA->phonecode}}">
                        </div>
