...
<sidebar id="sidebar" class="app-sidebar">
   <div data-scrollbar="true" data-height="100%">
      <ul class="nav">
         ...
         <li class="{{ $currentUrl == route('admin/content/edit', ['id' => 1]) ? 'active' : '' }}">
            <a href="{{ route('admin/content/edit', ['id' => 1]) }}">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
         ...
         <li class="{{ $currentUrl == route('admin/categories/list') ? 'active' : '' }}">
            <a href="{{ route('admin/categories/list') }}">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
               <span class="nav-text">Categories</span>
            </a>
         </li>
         <li class="{{ $currentUrl == route('admin/product/list') ? 'active' : '' }}">
         ...
         <li class="{{ $currentUrl == route('admin/project/list') ? 'active' : '' }}">
