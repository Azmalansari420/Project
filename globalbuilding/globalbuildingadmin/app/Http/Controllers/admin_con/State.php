...
class State extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'State',
                            'table_name'=>'state',
                            'upload_path'=>'media/uploads/state/',
                            'table_data_page_url'=>'admin/state/table',
                            'table_data_pagination_limit'=>50,
                            'load_list_path'=>'admin/state/list',
                            /*load form path and update url*/
                            'add_form_path'=>'admin/state/form',
                            'addupdate_form'=>'admin_con/state/storeOrUpdate',
                            /*add page*/
                            'add_page_link'=>'state/add',
                            /*edit page*/
                            'edit_page_url'=>'admin/state/edit',
                            'view_page_url'=>'admin/state/view',
                            /*status*/
                            'status_url'=>'admin/state/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/state/delete_data',
                            'multiple_delete'=>'admin_con/state/multiple_delete_data',
                            'check_image'=>true,
                            'controller_name'=>'state',
                            'page_name'=>'state-wise-job',    
