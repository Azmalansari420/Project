...
class Product extends Controller
{
    protected $arr_values = array(
                            ...
                            'table_data_page_url'=>'admin/product/table',
                            'table_data_pagination_limit'=>10,
                            'load_list_path'=>'admin/product/list',
                            /*load form path and update url*/
                            'add_form_path'=>'admin/product/form',
                            'addupdate_form'=>'admin_con/product/storeOrUpdate',
                            /*add page*/
                            'add_page_link'=>'product/add',
                            /*edit page*/
                            'edit_page_url'=>'admin/product/edit',
                            'view_page_url'=>'admin/product/view',
                            /*status*/
                            'status_url'=>'admin/product/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/product/delete_data',
                            'multiple_delete'=>'admin_con/product/multiple_delete_data',
                            'check_image'=>true,
