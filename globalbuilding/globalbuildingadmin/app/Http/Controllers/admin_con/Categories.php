...
class Categories extends Controller
{
    protected $arr_values = array(
                            ...
                            'table_data_page_url'=>'admin/categories/table',
                            'table_data_pagination_limit'=>10,
                            'load_list_path'=>'admin/categories/list',
                            /*load form path and update url*/
                            'add_form_path'=>'admin/categories/form',
                            'addupdate_form'=>'admin_con/categories/storeOrUpdate',
                            /*add page*/
                            'add_page_link'=>'categories/add',
                            /*edit page*/
                            'edit_page_url'=>'admin/categories/edit',
                            'view_page_url'=>'admin/categories/view',
                            /*status*/
                            'status_url'=>'admin/categories/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/categories/delete_data',
                            'multiple_delete'=>'admin_con/categories/multiple_delete_data',
                            'check_image'=>true,
