...
class City extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'City',
                            'table_name'=>'city',
                            'upload_path'=>'media/uploads/city/',
                            'table_data_page_url'=>'admin/city/table',
                            'table_data_pagination_limit'=>50,
                            'load_list_path'=>'admin/city/list',
                            /*load form path and update url*/
                            'add_form_path'=>'admin/city/form',
                            'addupdate_form'=>'admin_con/city/storeOrUpdate',
                            /*add page*/
                            'add_page_link'=>'city/add',
                            /*edit page*/
                            'edit_page_url'=>'admin/city/edit',
                            'view_page_url'=>'admin/city/view',
                            /*status*/
                            'status_url'=>'admin/city/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/city/delete_data',
                            'multiple_delete'=>'admin_con/city/multiple_delete_data',
                            'check_image'=>true,
                            'controller_name'=>'city',
                            'page_name'=>'city-wise-job',    
   ...
   public function getTableData(Request $request)
    ...
    public function getstatename(Request $request)
    {
        ...
        $country_id = $request->input('country_id'); 
        $statename = DB::table('state')->where('country_id',$country_id)->get();
        if(!empty($statename))
        {
