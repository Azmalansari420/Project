...
class Project extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'Project',
                            'table_name'=>'project',
                            'upload_path'=>'media/uploads/project/',
                            'table_data_page_url'=>'admin/project/table',
                            'table_data_pagination_limit'=>10,
                            'load_list_path'=>'admin/project/list',
                            /*load form path and update url*/
                            'add_form_path'=>'admin/project/form',
                            'addupdate_form'=>'admin_con/project/storeOrUpdate',
                            /*add page*/
                            'add_page_link'=>'project/add',
                            /*edit page*/
                            'edit_page_url'=>'admin/project/edit',
                            'view_page_url'=>'admin/project/view',
                            /*status*/
                            'status_url'=>'admin/project/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/project/delete_data',
                            'multiple_delete'=>'admin_con/project/multiple_delete_data',
                            'check_image'=>true,
