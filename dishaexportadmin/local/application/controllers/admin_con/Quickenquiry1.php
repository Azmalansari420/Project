...
class Quickenquiry1 extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'Enquirys',
						   	'table_name'=>'quickenquiry',
						   	'upload_path'=>'media/uploads/quickenquiry1/',
						   	'load_path'=>'admin/quickenquiry1/',
						   	'redirect_path'=>'admin_con/quickenquiry1/',
						   	'back_url'=>'quickenquiry1',
						   	'add_url'=>'quickenquiry1',
						   	'edit_url'=>'quickenquiry1',
						   	'delete_url'=>'quickenquiry1',
						   	'view_url'=>'quickenquiry1',
						   	'table_url'=>'admin/quickenquiry1/table',
						   	'status_value'=>'quickenquiry1',
						   	'multiple_delete'=>'admin_con/quickenquiry1/delete_all',
						   	'pagination_url'=>'admin_con/quickenquiry1/get_table_data',
						   	'controller_name'=>'quickenquiry1',
						   	'page_name'=>'quickenquiry1.php',
						   	'pagination_limit'=>'10',
						   ); 
   ...
   //--check user login or not
	...
	public function get_table_data() 
	{
	  ...
	  $this->db->where('type', 1); // Ensure role filtering
	  $this->db->group_start();
