        ...
        <section class="team-one team-one--team">
            <div class="container">
                <div class="row">
                    ...
                    $product = $this->db->get_where('product',array('status'=>1,'sub_cat_id'=>$EDITDATA[0]->id))->result_object();
                    // print_r($product);
                    if(!empty($product))
                    {
                ...
                <?php } }else{?>
                    <div class="col-xl-12 col-lg-12 wow fadeInUp text-center" data-wow-delay="100ms">
