...
<sidebar id="sidebar" class="app-sidebar">
   <div data-scrollbar="true" data-height="100%">
      <ul class="nav">
         ...
         <li class="<?php if($currentURL==base_url('admin_con/sub_categories/listing')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/sub_categories/listing');?>">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
         ...
         <li class="<?php if($currentURL==base_url('admin_con/quickenquiry1/listing')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/quickenquiry1/listing');?>">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
               <span class="nav-text">Quick Enquiry</span>
            </a>
         </li>
         <li class="<?php if($currentURL==base_url('admin_con/quickenquiry2/listing')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/quickenquiry2/listing');?>">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
               <span class="nav-text">Interested Enquiry</span>
            </a>
         </li>
