  ...
  .site-footer {
    ...
    background-color: #015a2d;
        ...
        <footer class="site-footer site-footer--two">
            <div class="site-footer--two__pattern"
                style="background-image: url(assets/images/pattern/site-footer-v2-pattern.png);"></div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0ms">
                            <div class="footer-widget__about">
                                <div class="footer-widget__about-logo">
                                    <a href="index.php"><img src="assets/logo.png" alt="" height="100px" style="background: white;  border-radius: 10px;"></a>
                                </div>
                            ...
                            <div class="site-footer__bottom-inner">
                                <div class="site-footer__copyright">
                                    <p class="site-footer__copyright-text">
                                        &copy; 2025 Dishaa Import Export By
                                        <a target="_blank"
                                ...
                                <div class="site-footer__bottom-menu">
                                    <ul>
                                        <li>
                                            <p><a href="about.php">Trams & Condition</a></p>
                                        </li>
                                        <li>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img src="assets/images/resources/logo-4.png" width="140"
                        alt="" /></a>
            </div>
            <!-- /.logo-box -->
    ...
    <div class="search-popup">
        ...
        <form method="post" action="https://unicktheme.com/2025/reroof/main-html/blog.html">
