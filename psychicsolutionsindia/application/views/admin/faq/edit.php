                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="question" id="ed2itor"  placeholder="Enter text ..." rows="12"><?php echo $EDITDATA[0]->question; ?></textarea>
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="answere" id="ed2itor"  placeholder="Enter text ..." rows="12"><?php echo $EDITDATA[0]->answere; ?></textarea>
                                 </div>
                              </div>
