                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="question" id="edito1r"  placeholder="Enter text ..." rows="12"></textarea>
                                 </div>
                              </div>
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Answere</label>
                                    <textarea class="form-control" name="answere" id="edito1r"  placeholder="Enter text ..." rows="12"></textarea>
                                 </div>
                              </div>
