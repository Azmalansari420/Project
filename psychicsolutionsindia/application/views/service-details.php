			...
			<div class="row">
				<div class="col-md">
					<div class="doctor-page-photo text-center">
						<img src="<?=base_url() ?>media/uploads/services/<?=$EDITDATA[0]->image ?>" class="img-about" alt="">
					</div>
				...
				<div class="col-lg-8 mt-4 mt-lg-0">
					<div class="doctor-info mb-3 mb-lg-4">
						...
						<!-- <div class="doctor-info-phone"><i class="icon-telephone"></i><a href="tel:0123456789">0123456789</a></div>
