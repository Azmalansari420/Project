        ...
        <div class="col-lg-5 d-flex align-items-stretch">
          <div class="info">
            <div class="content-box p-2">
              ...
              <p class="py-2"><strong>Email:</strong> <a href="mailto:support@indiagemregistration.org">support@indiagemregistration.org</a></p>

              <p class="py-2"><strong>Phone:</strong> <a href="tel:7827114607">+91-7827114607 (General Enquiries)</a></p>
              <p class="py-2"><strong>Branch Address:</strong> <a href="#!">3404, Varanashi, Varanashi, Bhitti, Rampur, Ramnager UP 221008</a></p>
              <p class="py-2"><strong>Office Address:</strong> <a href="#!">A1/92 Janakpuri New Delhi 110058</a></p>
