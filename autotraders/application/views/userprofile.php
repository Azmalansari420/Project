               ...
               <div class="row justify-content-center">
                  <div class="col-lg-12">
                     <div class="white_box mb_30">
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('user/user_update'); ?>">
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="mobile" value="<?php echo $user[0]->mobile; ?>" disabled>
                           </div>
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" class="form-control" value="<?php echo $user[0]->password; ?>" disabled>
                           </div>

                           <div class="mb-3">
                              <label class="form-label">Update Password</label>
                              <input type="password" class="form-control" value="<?php echo $user[0]->password; ?>" name="password">
                           </div>

                           <div class="mb-3">
                              <label class="form-label">Update Profile Image</label>
                              <input type="file" class="form-control" name="image">
                              <input type="hidden" name="oldimage" value="<?php echo $user[0]->image; ?>">
                           </div>
