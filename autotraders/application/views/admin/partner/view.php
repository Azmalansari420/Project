                                    ...
                                    <div class="col-md-9">
                                        <div class="row g-3 date-icon-set-modal">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="title" class="form-control"  value="<?php echo $EDITDATA[0]->title; ?>" disabled>
                                            </div>


                                            <div class="col-md-6 mb-3">
                                                <label  class="form-label font-weight-bold text-muted text-uppercase">Sub Title</label>
                                                <input type="text" name="sub_title" class="form-control"  value="<?php echo $EDITDATA[0]->sub_title; ?>" disabled>
                                            </div>


                                            <div class="col-md-12 mb-3">
                                                <label  class="form-label font-weight-bold text-muted text-uppercase">Content</label>
                                                <textarea disabled class="form-control" name="content" ><?php echo $EDITDATA[0]->content; ?></textarea>
                                            </div>

                                                                                        
                                            <div class="col-md-12 mb-3">
                                                <label  class="form-label font-weight-bold text-muted text-uppercase">Status</label>
                                                <select disabled id="inputState" name="status" class="form-select form-control choicesjs">
