                                    ...
                                    <div class="col-md-9">
                                        <div class="row g-3 date-icon-set-modal">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label  class="form-label font-weight-bold text-muted text-uppercase">Title</label>
                                                <input type="text" name="title" class="form-control"  value="<?php echo $EDITDATA[0]->title; ?>">
                                            </div>


                                            <div class="col-md-6 mb-3">
                                                <label  class="form-label font-weight-bold text-muted text-uppercase">Sub Title</label>
                                                <input type="text" name="sub_title" class="form-control"  value="<?php echo $EDITDATA[0]->sub_title; ?>">
                                            </div>


                                            <div class="col-md-6 mb-3">
                                                <label  class="form-label font-weight-bold text-muted text-uppercase">URL</label>
                                                <input type="text" name="url" class="form-control" value="<?php echo $EDITDATA[0]->url; ?>">
                                            </div>

                                            
                                            <div class="col-md-6 mb-3">
                                                <label  class="form-label font-weight-bold text-muted text-uppercase">URL Name</label>
                                                <input type="text" name="url_name" class="form-control"value="<?php echo $EDITDATA[0]->url_name; ?>">
                                            </div>
