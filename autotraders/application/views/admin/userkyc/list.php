                                        ...
                                        <table class="table data-table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="white-space-no-wrap">
                                                    ...
                                                    <td class="">
                                                        <img src="<?php echo base_url($upload_path); ?><?php echo $data->pancard; ?>" width="75">
                                                    </td>
                                                    <td class="">
                                                        <img src="<?php echo base_url($upload_path); ?><?php echo $data->adharcard; ?>" width="75">
                                                    </td>
                                                    <td class="">
                                                        <img src="<?php echo base_url($upload_path); ?><?php echo $data->bankstatement; ?>" width="75">
                                                    </td>
                                                    <td class="">
                                                        <img src="<?php echo base_url($upload_path); ?><?php echo $data->profilepic; ?>" width="75">
                                                    </td>
