                           ...
                           <div class="row">
                              <div class="col-lg-12 text-center" style="margin-bottom: 26px;">
                                 <div class="single_quick_activity" style="background:white;    padding-top: 0;">
                                    ...
                                    <p class="start-lear" onclick="reffer_link()" style="background:#ffb901;cursor: pointer;">COPY REFERRAL LINK</p>

                                    <input type="hidden" id="reffer_link" value="<?=base_url() ?>login#mortgage?sponser_id=<?=$user[0]->user_id ?>">
                              ...
                              <div class="col-12">
                                 <div class="quick_activity_wrap">
                                    ...
                                    <div class="single_quick_activity" style="background:#c7f6d6;">
                                       <h4 style="color: black;">My Income</h4>
