...
class Userhelp extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'User Enquiry',
						   	'table_name'=>'userhelp',
						   	'upload_path'=>'media/uploads/userhelp/',
						   	'load_path'=>'admin/userhelp/',
						   	'redirect_path'=>'admin_con/userhelp/',
						   	'back_url'=>'userhelp',
						   	'edit_url'=>'userhelp',
						   	'delete_url'=>'userhelp',
						   	'view_url'=>'userhelp',
						   	'status_value'=>'userhelp',
						   );
