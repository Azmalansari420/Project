...
<style>
      ...
      <div class="th-hero-wrapper hero-1" id="hero" data-bg-src="<?=base_url() ?>assets/img/hero/hero_bg_1_1.jpg">
         <div class="hero-inner">
            <div class="shape-mockup jump shape-1"><img src="<?=base_url() ?>assets/img/shape/hero_shape_1_1.svg" alt="shape"></div>
            <div class="shape-mockup moving shape-2"><img src="<?=base_url() ?>assets/img/shape/hero_shape_1_2.svg" alt="shape"></div>
            <div class="shape-mockup moving shape-3"><img src="<?=base_url() ?>assets/img/shape/hero_shape_1_3.svg" alt="shape"></div>
            <div class="shape-mockup jump-reverse shape-4"><img src="<?=base_url() ?>assets/img/shape/hero_shape_1_4.svg" alt="shape"></div>
            <div class="shape-mockup jump shape-5"><img src="<?=base_url() ?>assets/img/shape/hero_shape_1_5.svg" alt="shape"></div>
            <div class="shape-mockup jump shape-6"><img src="<?=base_url() ?>assets/img/shape/hero_shape_1_6.svg" alt="shape"></div>

            <div class="container">
               <div class="hero-style1">
                  <span class="sub-title">We Clean, You Shine</span>
                  <h1 class="hero-title"><span class="title1">Fast & Reliable Home</span> <span class="title2">  Services at Your</span> <span class="title2">  Doorstep</span></h1>
            ...
            <div class="hero-img text-center mobile-none">
               <img src="<?=base_url() ?>assets/img/hero/hero_1_1.png" alt="Image" style="width:70%">
            </div>
         </div>
      </div>
         ...
         <div class="container">
            <div class="row gy-30 align-items-center">
               <div class="col-xl-7 mb-xl-0">
                  <div class="img-box1">
                     <div class="img1 jump-reverse"><img src="<?=base_url() ?>assets/img/about/about-1-left.jpg" alt="About"></div>
                     <div class="shape1 jump"><img src="<?=base_url() ?>assets/img/about/about-1-right.jpg" alt="Image"></div>
                     <div class="img2">
                        <img class="tilt-active" src="<?=base_url() ?>assets/img/about/about-1-main.jpg" alt="Image">
               ...
               <div class="col-xl-5">
                  <div class="title-area">
                     ...
                     <p class="sec-text">A cleaning service company specializes in providing professional cleaning solutions for residential, commercial, and industrial spaces. These services range from regular housekeeping tasks to deep cleaning, sanitation, and specialized cleaning services.</p>
                  </div>
...
<!--       <section class="space pt-0 ">
            ...
            <div class="row gy-30 justify-content-center">
               <div class="col-xl-4 col-sm-6">
                  <div class="feature-item">
                     <div class="feature-item__icon"><img src="<?=base_url() ?>assets/img/icon/feature-1.svg" alt="Icon"></div>
                     <h3 class="box-title">Book a Service</h3>
                     <p class="feature-item__text">Get expert technicians quickly for your home. We ensure timely and efficient service for all your needs.</p>
                  </div>
               </div>
               <div class="col-xl-4 col-sm-6">
                  <div class="feature-item">
                     <div class="feature-item__icon"><img src="<?=base_url() ?>assets/img/icon/feature-2.svg" alt="Icon"></div>
                     <h3 class="box-title">Technical Assigned</h3>
                     <p class="feature-item__text">A qualified technician is assigned to your request and will contact you shortly for assistance.</p>
                  </div>
               </div>
               <div class="col-xl-4 col-sm-6">
                  <div class="feature-item">
                     <div class="feature-item__icon"><img src="<?=base_url() ?>assets/img/icon/feature-3.svg" alt="Icon"></div>
                     <h3 class="box-title">Service Complete</h3>
                     <p class="feature-item__text">Your service is completed with satisfaction, ensuring everything works perfectly as expected.</p>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section class="th-service-1 overflow-hidden space pt-0 pb-2" id="service-sec" data-bg-src="<?=base_url() ?>assets/img/bg/service-bg-1-1.png">
         ...
         <div class="container">
            ...
            <!-- 11 -->
            <div class="row gy-30 justify-content-center" id="Electrician-Services">
               <div class="col-xl-6">
                  <div class="why-2-left">
                     <div class="img2"><img src="<?=base_url() ?>assets/electric.jpg" alt="Image" style="border-radius: 10px;"></div>
                  </div>
               </div>
               <div class="col-xl-6">
                  <div class="why-2-right">
                     <div class="title-area">
                        <h2 class="sec-title">1. Electrician Services</h2>
                     ...
                     <div class="checklist style2 mb-35">
                  	...
                  	<div>
                  		<button   class="th-btn star-btn" onclick="openModal()">Discover More</button >
                  	</div>
                  </div>
               </div>
            </div>
            ...
            <div class="row gy-30 justify-content-center mt-4" id="TV-Repair">               
               <div class="col-xl-6">
                  <div class="why-2-right">
                     <div class="title-area">
                        <h2 class="sec-title">2. TV Repair & Installation</h2>
                        <p class="sec-text">House cleaning services are professional services designed to clean and maintain residential spaces. They provide convenience and ensure a hygienic living environment for homeowners, often offering various packages tailored to different needs and preferences.</p>
                     </div>
               ...
               <div class="col-xl-6">
                  <div class="why-2-left">
                     <div class="img2"><img src="<?=base_url() ?>assets/tv.jpg" alt="Image" style="border-radius: 10px;"></div>
                  </div>
               </div>
            </div>
            ...
            <div class="row gy-30 justify-content-center mt-4" id="AC-Repair">
               <div class="col-xl-6">
                  <div class="why-2-left">
                     <div class="img2"><img src="<?=base_url() ?>assets/ac.jpg" alt="Image" style="border-radius: 10px;"></div>
                  </div>
               </div>
               <div class="col-xl-6">
                  <div class="why-2-right">
                     <div class="title-area">
                        <h2 class="sec-title">3. AC Repair & Services</h2>
                        <p class="sec-text">House cleaning services are professional services designed to clean and maintain residential spaces. They provide convenience and ensure a hygienic living environment for homeowners, often offering various packages tailored to different needs and preferences.</p>
                     </div>
            ...
            <div class="row justify-content-lg-between justify-content-center align-items-center">
               <div class="col-xl-12 text-center text-xl-start">
                  <div class="title-area">
                     ...
                     <h2 class="sec-title">Choose Excellence, Choose Kleanix</h2>
                  </div>
               </div>
            </div>
            <div class="row gx-60 gy-40 align-items-center justify-content-center">
               <div class="col-xl-4 col-lg-8">
                  <div class="why-img-box1">
                     <div class="img1"><img src="<?=base_url() ?>assets/img/why/why-choose-left.jpg" alt="why-img"></div>
                  </div>
               </div>
               <div class="col-xl-8">
                     ...
                     <div class="swiper has-shadow th-slider" id="testiSlide1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"}}}'>
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="testi-block style-3" dir="ltr">
                                 <div class="testi-block-top">
                                    <div class="box-img"><img src="<?=base_url() ?>assets/img/testimonial/testi_1_1.jpg" alt="Avater"></div>
                                    <div class="content">
                                 ...
                                 <p class="box-text">Regular and thorough cleaning maintains the appearance and extends the life of surfaces, furnishings, and fixtures.</p>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="testi-block style-3" dir="ltr">
                                 <div class="testi-block-top">
                                    <div class="box-img"><img src="<?=base_url() ?>assets/img/testimonial/testi_1_2.jpg" alt="Avater"></div>
                                    <div class="content">
                           ...
                           <div class="swiper-slide">
                              <div class="testi-block style-3" dir="ltr">
                                 <div class="testi-block-top">
                                    <div class="box-img"><img src="<?=base_url() ?>assets/img/testimonial/testi_1_3.jpg" alt="Avater"></div>
                                    <div class="content">
                                       <h3 class="box-title">Louis Swanson</h3>
                                       <p class="box-desig">Homeowner</p>
                                    </div>
                                 </div>
                                 <div class="box-review"><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i></div>
                           ...
                           <div class="swiper-slide">
                              <div class="testi-block style-3" dir="ltr">
                                 <div class="testi-block-top">
                                    <div class="box-img"><img src="<?=base_url() ?>assets/img/testimonial/testi_1_4.jpg" alt="Avater"></div>
                                    <div class="content">
                                       <h3 class="box-title">Curry Summit</h3>
                                       <p class="box-desig">Homeowner</p>
                                    </div>
                                 </div>
                                 <div class="box-review"><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i></div>
                           ...
                           <div class="swiper-slide">
                              <div class="testi-block style-3" dir="ltr">
                                 <div class="testi-block-top">
                                    <div class="box-img"><img src="<?=base_url() ?>assets/img/testimonial/testi_1_5.jpg" alt="Avater"></div>
                                    <div class="content">
                                       <h3 class="box-title">Tusara Bamilton</h3>
                                       <p class="box-desig">Homeowner</p>
                                    </div>
                                 </div>
                                 <div class="box-review"><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i></div>
                           ...
                           <div class="swiper-slide">
                              <div class="testi-block style-3" dir="ltr">
                                 <div class="testi-block-top">
                                    <div class="box-img"><img src="<?=base_url() ?>assets/img/testimonial/testi_1_6.jpg" alt="Avater"></div>
                                    <div class="content">
                                       <h3 class="box-title">Brenten Taylor</h3>
                                       <p class="box-desig">Homeowner</p>
                                    </div>
                                 </div>
                                 <div class="box-review"><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i></div>
                           ...
                           <div class="swiper-slide">
                              <div class="testi-block style-3" dir="ltr">
                                 <div class="testi-block-top">
                                    <div class="box-img"><img src="<?=base_url() ?>assets/img/testimonial/testi_1_7.jpg" alt="Avater"></div>
                                    <div class="content">
                                       <h3 class="box-title">Hazelip Bell</h3>
                                       <p class="box-desig">Homeowner</p>
                                    </div>
                                 </div>
                                 <div class="box-review"><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i></div>
                           ...
                           <div class="swiper-slide">
                              <div class="testi-block style-3" dir="ltr">
                                 <div class="testi-block-top">
                                    <div class="box-img"><img src="<?=base_url() ?>assets/img/testimonial/testi_1_8.jpg" alt="Avater"></div>
                                    <div class="content">
                                       <h3 class="box-title">Alex Joshep</h3>
                                       <p class="box-desig">Homeowner</p>
                                    </div>
                                 </div>
                                 <div class="box-review"><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i></div>
                           ...
                           <div class="swiper-slide">
                              <div class="testi-block style-3" dir="ltr">
                                 <div class="testi-block-top">
                                    <div class="box-img"><img src="<?=base_url() ?>assets/img/testimonial/testi_1_9.jpg" alt="Avater"></div>
                                    <div class="content">
                                       <h3 class="box-title">Henry Carlos</h3>
                                       <p class="box-desig">Homeowner</p>
                                    </div>
                                 </div>
                                 <div class="box-review"><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i></div>
...
<div id="myModal" class="modal" style="display: none; align-items: center; justify-content: center;">
