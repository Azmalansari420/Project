...
<footer class="footer-wrapper footer-default" data-bg-src="assets/dimg/bg/footer_bg_1.jpg">
         <div class="shape-mockup footer-shape-1 jump-reverse d-none d-xxl-block"><img src="assets/img/icon/footer-shape-1.png" alt="shape"></div>
         <div class="shape-mockup footer-shape-2 jump-reverse"><img src="assets/img/icon/footer-shape-2.png" alt="shape"></div>
         <div class="footer-bottom-shape" data-mask-src="assets/img/bg/footer-shape-bottom.png"></div>
         <div class="footer-top">
            <div class="container">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="footer-logo-wrap">
                        <div class="footer-logo"><a href="index.php"><img src="assets/logo.png" alt="Green India Team" style="width:150px"></a></div>
                     ...
                     <div class="widget widget_nav_menu footer-widget">
                        ...
                        <div class="menu-all-pages-container">
                           <ul class="menu">
                              ...
                              <li><a href="#testi-sec">Review</a></li>
                     ...
                     <div class="widget widget_nav_menu footer-widget">
                        ...
                        <div class="menu-all-pages-container">
                           <ul class="menu">
                              ...
                              <li><a href="#TV-Repair">TV Repair & Installation</a></li>
                              <li><a href="#AC-Repair">AC Repair & Services</a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
         ...
         <div class="copyright-wrap">
            <div class="container">
               <div class="row gy-2 align-items-center">
                  <div class="col-md-12">
                     <p class="copyright-text text-center">Copyright <i class="fal fa-copyright"></i> 2025 <a href="index.php">Green India Team</a>. All Rights Reserved.</p>
                  </div>
               </div>
            </div>
         </div>
...
<div class="modal" id="serviceModal" style="display: none; align-items: center; justify-content: center;">
    <div class="modal-content" style="padding: 20px; max-width: 400px; background: #fff; border-radius: 8px; position: relative;">
        ...
        <form>
            ...
            <select name="subject" class="input-size" required style="width:100%!important;">
            ...
            <button type="submit" class="th-btn star-btn">Submit Message</button>
        </form>
    </div>
</div>
