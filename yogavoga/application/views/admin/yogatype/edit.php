                                    ...
                                    <div class="col-md-9">
                                        <div class="row g-3 date-icon-set-modal">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input type="text" name="name" class="form-control" value="<?php echo $EDITDATA[0]->name; ?>">
                                            </div>

                                            
                                            <div class="col-md-12 mb-3">
                                                <label  class="form-label font-weight-bold text-muted text-uppercase">Content</label>
                                                <textarea class="form-control" name="content" rows="5" placeholder="Enter Content"><?php echo $EDITDATA[0]->content; ?></textarea>
                                            </div>

                                            <div class="col-md-6 mb-3">
                                                <label  class="form-label font-weight-bold text-muted text-uppercase">Show On Home</label>
                                                <select id="inputState" name="showhome" class="form-select form-control choicesjs">
                                                    <option <?php if($EDITDATA[0]->showhome==1)echo 'selected'; ?> value="1" selected>Yes</option>
                                                    <option <?php if($EDITDATA[0]->showhome==0)echo 'selected'; ?> value="0">No</option>
                                                </select>
                                            </div>
