           ...
           <div class="data-scrollbar" data-scroll="1">
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="side-menu">
                        ...
                        <li class=" sidebar-layout">
                            <a href="<?php echo base_url('admin_con/product/listing');?>" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <li class=" sidebar-layout">
                            <a href="<?php echo base_url('admin_con/yogatype/listing');?>" class="svg-icon ">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                    </svg>
                                </i>
                                <span class="ml-2">Yoga Type</span>
                            </a>
                        </li>


                        <li class=" sidebar-layout">
                            <a href="<?php echo base_url('admin_con/healbody/listing');?>" class="svg-icon">
                                <i class="">
                                ...
                                <span class="ml-2">Heal Your Body</span>
                            </a>
                        </li>

                        <li class=" sidebar-layout">
                            <a href="<?php echo base_url('admin_con/yogahome/listing');?>" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                ...
                                <span class="ml-2">Yoga At Home</span>
                            </a>
                        </li>
                       ...
                       <!--  <li class="sidebar-layout">
                        ...
                        <li class="sidebar-layout">
                            <a href="#app2" class="collapsed svg-icon" data-toggle="collapse" aria-expanded="false">
                                ...
                                <span class="ml-2">All Enquiry</span>
                            ...
                            <ul id="app2" class="submenu collapse" data-parent="#iq-sidebar-toggle">                        
                                <li class=" sidebar-layout">
                                    <a href="<?php echo base_url('admin_con/contact/listing');?>" class="svg-icon">
                                        ...
                                        </i><span class="">Book Demo Enquirys</span>
                                    </a>
                                </li>
                                <li class=" sidebar-layout">
                                    <a href="<?php echo base_url('admin_con/trainning_partner/listing');?>" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                              <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
                                            </svg>

                                        </i><span class=""> Joining for new Trainer </span>
                                    </a>
                                </li>
                                <li class=" sidebar-layout">
                                    <a href="<?php echo base_url('admin_con/review/listing');?>" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                              <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
                                            </svg>

                                        </i><span class="">Review </span>
                                    </a>
                                </li>
                            </ul>
                        </li>
