                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row g-3 date-icon-set-modal">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label  class="form-label font-weight-bold text-muted text-uppercase">Price</label>
                                                <input type="text" name="price" class="form-control" value="<?php echo $EDITDATA[0]->price; ?>">
                                            </div>

                                            <div class="col-md-6 mb-3">
                                                <label  class="form-label font-weight-bold text-muted text-uppercase">Cut Price</label>
                                                <input type="text" name="cut_price" class="form-control" value="<?php echo $EDITDATA[0]->cut_price; ?>">
                                            </div>
