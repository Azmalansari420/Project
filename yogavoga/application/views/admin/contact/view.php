                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <form class="row g-3 date-icon-set-modal">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <label for="Text3" class="form-label font-weight-bold text-muted text-uppercase">Subject</label>
                                            <input type="text" class="form-control" name="subject" value="<?php echo $EDITDATA[0]->subject; ?>" disabled>
                                        </div>


                                        <div class="col-md-12 mb-3">
                                            <label for="Text9" class="form-label font-weight-bold text-muted text-uppercase">Message</label>
                                            <textarea class="form-control" id="Text9" rows="2" name="message" disabled><?php echo $EDITDATA[0]->message; ?></textarea>
                                        </div>
