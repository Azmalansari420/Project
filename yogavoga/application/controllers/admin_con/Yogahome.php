...
class yogahome extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'Yoga At Home',
						   	'table_name'=>'yogahome',
						   	'upload_path'=>'media/uploads/yogahome/',
						   	'load_path'=>'admin/yogahome/',
						   	'redirect_path'=>'admin_con/yogahome/',
						   	'back_url'=>'yogahome',
						   	'add_url'=>'yogahome',
						   	'edit_url'=>'yogahome',
						   	'delete_url'=>'yogahome',
						   	'view_url'=>'yogahome',
						   	'status_value'=>'yogahome',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			// $data['showhome'] = $this->input->post('showhome');			
