      ...
      <div id="sidebar" class="app-sidebar">
            <div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
               <div class="menu">
                  ...
                  <div class="menu-item">
                     <a href="<?php echo base_url('admin_con/affiliations/listing');?>" class="menu-link">
                        <div class="menu-icon">
                           <i class="fa fa-server"></i>
                        </div>
                        <div class="menu-text">Affiliations</div>
                     </a>
                  </div>
                  <div class="menu-item">
                  ...
                  <div class="menu-item">
                     <a href="<?php echo base_url('admin_con/Career/listing');?>" class="menu-link">
                        <div class="menu-icon">
                           <i class="fa fa-server"></i>
                        </div>
                        <div class="menu-text">Career Enquiry</div>
                     </a>
                  </div>
                  <div class="menu-item">
