...
class Faqs extends CI_Controller
{
	...
	protected $arr_values = array(
						   	'page_title'=>'Faqs',
						   	'table_name'=>'faqs',
						   	'upload_path'=>'media/uploads/faqs/',
						   	'load_path'=>'admin/faqs/',
						   	'redirect_path'=>'admin_con/faqs/',
						   	'back_url'=>'faqs',
						   	'add_url'=>'faqs',
						   	'edit_url'=>'faqs',
						   	'delete_url'=>'faqs',
						   	'view_url'=>'faqs',
						   	'status_value'=>'faqs',
						   	'multiple_delete'=>'admin_con/faqs/delete_all',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$data['answere'] = $this->input->post('answere');			
