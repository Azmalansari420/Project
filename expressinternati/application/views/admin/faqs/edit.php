                           ...
                           <div class="row">
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="question" value="<?php echo $EDITDATA[0]->question; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="answere" id="edito1r"  placeholder="Enter text ..." rows="12"><?php echo $EDITDATA[0]->answere; ?></textarea>
                                 </div>
                              </div>
