            ...
            <div class="d-flex align-items-center mb-3">
               <div>
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active"><i class="fa fa-arrow-back"></i> Edit Home Content</li>
                  </ol>
                  <h1 class="page-header mb-0">Edit Home Content</h1>
               </div>
            </div>
                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="url"  value="<?=$EDITDATA[0]->url ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="content" id="editor" rows="6"><?php echo $EDITDATA[0]->content; ?></textarea>
                                 </div>
                              </div>
