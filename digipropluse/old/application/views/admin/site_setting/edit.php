                  ...
                  <div class="card m-b-15">
                     <div class="row card-body">
                        ...
                        <div class="col-6 form-group">
                           ...
                           <input type="number" class="form-control" name="vendor_comis" value="<?php echo $EDITDATA[0]->vendor_comis; ?>">
                        </div>

                        <div class="col-6 form-group">
                           <label>Dealer Commision </label>
                           <input type="number" class="form-control" name="dealer_comis" value="<?php echo $EDITDATA[0]->dealer_comis; ?>">
                        </div>
