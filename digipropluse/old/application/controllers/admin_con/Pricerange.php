...
class Pricerange extends CI_Controller
{
   ...
   //--check user login or not
	...
	function add()
	{
		check_controller_inner_access(16,2);
	...
	function listing()
	{		
		check_controller_inner_access(16,1);
		$data['page_title'] = $this->arr_values['page_title'];
	...
	public function delete()
	  {
	  	check_controller_inner_access(16,4);
	...
	function edit()
	{
		check_controller_inner_access(16,3);		 
		$args=func_get_args();
		if(isset($_POST['submit']))
		{
			date_default_timezone_set('Asia/Kolkata');
	...
	function view()
	{
		check_controller_inner_access(16,5);		 
		$args=func_get_args();
		$data['page_title'] = $this->arr_values['page_title'];
		$data['upload_path'] = $this->arr_values['upload_path'];
		$data['back_url'] = base_url('admin_con/'.$this->arr_values['back_url'].'/listing');
