...
class Blog extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'delete_url'=>'blog',
						   	'view_url'=>'blog',
						   	'table_url'=>'admin/blog/table',
						   	'status_value'=>'blog',
						   	'multiple_delete'=>'admin_con/blog/delete_all',
						   	'pagination_url'=>'admin_con/blog/get_table_data',
						   	'controller_name'=>'blog',
						   	'page_name'=>'blog-details.php',
						   	'pagination_limit'=>'10',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		check_controller_inner_access(13,2);
	...
	function edit()
	{
		check_controller_inner_access(13,3);		 
		$args=func_get_args();
		if(isset($_POST['submit']))
		{
			date_default_timezone_set('Asia/Kolkata');
