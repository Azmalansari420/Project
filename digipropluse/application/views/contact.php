                            ...
                            <ul class="mt-40 mb-40">
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mt-1"><a class="text-white" href="tel:<?=$sitesetting[0]->mobile ?>"><?=$sitesetting[0]->alt_mobile ?></a>
                                        </h3>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mt-1">
                                            <a class="text-white" href="mailto:<?=$sitesetting[0]->email ?>"><?=$sitesetting[0]->email ?></a>
                                        </h3>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mt-1"><a class="text-white" href="#!"><?=$sitesetting[0]->address ?></a>
                                        </h3>
                                    </div>
                                </li>
                            </ul>
