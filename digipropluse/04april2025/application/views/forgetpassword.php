                    ...
                    <div class="col-lg-6">
                        <div class="contact__right-item">
                            <div class="section-header mb-20">
                                ...
                                <h2 class="wow fadeInUp mb-2" data-wow-delay="200ms" data-wow-duration="1500ms">Forget Pasword</h2>
                                <?php echo $this->session->flashdata('message') ?>
                            </div>
                            <div class="contact__form">
                                <form action="<?=base_url() ?>welcome/forget_password" method="post">
                                    <div class="row">

                                        <div class="col-12">
                                            <label for="email">Your Email or Mobile*</label>
                                            <input class="bg-transparent bor" id="email" type="email" placeholder="Your Email or Mobile" name="email">
                                        </div> 
                                    ...
                                    <div class="text-end">
                                        <a href="<?=base_url() ?>login">Click to Login</a>
                                    </div>
