                                ...
                                <div class="contact__form">
	                                <form action="<?=base_url('welcome/searchplan') ?>" method="post">
	                                    ...
	                                    <div class="row">
	                                        ...
	                                        <div class="col-12" onclick="document.getElementById('purchase_date_input').showPicker()">
        ...
        <section class="pricing-area pt-0 pb-120">
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <?php
                    $plan = $this->db->get_where('plans',array('status'=>1,'product_id'=>$EDITDATA[0]->id))->result_object();
...
<script type="text/javascript">
    document.getElementById('purchase_date_input').showPicker?.() || document.getElementById('purchase_date_input').focus();
