<?php include('header.php'); ?>
    ...
    <main>
        ...
        <section class="banner__inner-page bg-image pt-50 pb-50 bg-image"
            data-background="<?=base_url() ?>assets/images/banner/banner-inner-page.jpg">
            ...
            <div class="container">
                ...
                <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <a href="index">Home</a><span><i class="fa-regular fa-angles-right mx-2"></i>Contact Us</span>
                </div>
            </div>
        </section>
                ...
                <div class="row g-4">
                    <div class="col-lg-5">
                        <div class="contact__left-item primary-bg">
                            ...
                            <ul class="mt-40 mb-40">
                                ...
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mt-1"><a class="text-white" href="tel:<?=$sitesetting[0]->mobile ?>"><?=$sitesetting[0]->mobile ?></a>
                                        </h3>
                                    </div>
                                </li>
                            <?php } ?>
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mt-1">
                                            <a style="font-size: 15px;" class="text-white" href="mailto:<?=$sitesetting[0]->email ?>"><?=$sitesetting[0]->email ?></a>
                                        </h3>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mt-1"><a style="font-size: 11px;" class="text-white" href="#!"><?=$sitesetting[0]->address ?></a>
                                        </h3>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="social">
                                <a href="<?=$sitesetting[0]->facebook ?>"><i style="color:black" class="fa-brands fa-facebook-f"></i></a>
                                <a href="<?=$sitesetting[0]->twitter ?>"><i style="color:black" class="fa-brands fa-twitter"></i></a>
                                <a href="<?=$sitesetting[0]->instagram ?>"><i style="color:black" class="fa-brands fa-instagram"></i></a>
                                <a href="<?=$sitesetting[0]->youtube ?>"><i style="color:black" class="fa-brands fa-youtube"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                                ...
                                <form action="<?=base_url('welcome/enquiry_form') ?>" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input class="bg-transparent bor" id="Mobile" type="number"
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input class="bg-transparent bor" id="Subject" type="text"
                                                placeholder="Your Subject" name="subject">
                                        </div>
                                    </div>
                                    <div class="text-area">
                                        <label for="massage">Write Message*</label>
                                        <textarea class="bg-transparent bor" id="massage" name="message" 
                                            placeholder="Write Message"></textarea>
                                    </div>
                                    <div class="btn-two">
                                        <span class="btn-circle">
                                        </span>
                                        <button type="submit" name="submit" class="btn-one">Send Message <i
