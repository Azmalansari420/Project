                                    ...
                                    <div class="col-lg-6">
                                       <div class="mb-3">
                                          ...
                                          <select class="form-select form-control" name="product_id" required id="product-list">
                                              ...
                                              <?php
                                              // Decode allotted product IDs
                                              $plan_per = json_decode($hospital->plan_per); // e.g., ["2", "3"]

                                              // Get all active products
                                              $products = $this->db->get_where('product', ['status' => 1])->result_object();

                                              foreach ($products as $value) {
                                                  // Show only if product ID is in allotted plan_per
                                                  if (in_array($value->id, $plan_per)) {
