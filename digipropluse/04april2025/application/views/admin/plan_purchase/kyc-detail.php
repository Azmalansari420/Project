                  ...
                  <div class="card m-b-15">
                     <div class="row card-body">
                        ...
                        <div class="col-3 form-group">
                           ...
                           <input type="text" class="form-control" name="sub_title" value="<?=($kycdata[0]->product_name) ?>" disabled>
                        </div>
                        <div class="col-3 form-group">
                           <label>Product Model </label>
                           <input type="text" class="form-control" name="sub_title" value="<?=($kycdata[0]->product_model) ?>" disabled>
                        </div>
