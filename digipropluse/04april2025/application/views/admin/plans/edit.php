                     ...
                     <div class="row card-body">
                        <div class="col-4 form-group m-b-0">
                           ...
                           <select class=" form-control" required name="product_id">
                              <?php
                              $prodcut = $this->db->get_where('product',array('status'=>1,))->result_object();
                              foreach ($prodcut as $key => $value) 
                                 { ?>
                              <option <?php if($EDITDATA[0]->product_id==$value->id) echo "selected"; ?> value="<?=$value->id ?>"><?=$value->name ?></option>
                           <?php } ?>
                           </select>
                        </div>
                        ...
                        <div class="col-6 form-group d-none">
                           ...
                           <input type="text" class="form-control" name="percentage" value="<?=$EDITDATA[0]->percentage ?>">
                        </div>
                        ...
                        <div class="row card-body" id="content-area">
                           <?php
                           if(!empty($EDITDATA[0]->content))
                              {
                                 $getallcontent = json_decode($EDITDATA[0]->content);
                             ...
                             <div class="col-12 form-group d-flex align-items-center">
                                 ...
                                 <input type="text" class="form-control" name="get_line[]" value="<?=$value->get_line ?>" />
