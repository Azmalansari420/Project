<?php
// $distric = "DP";
// $ff = generate_user_id_withname($distric);
// print_r($ff);
// die;
?>
                  ...
                  <div class="card m-b-15">
                     <div class="row card-body">
                        ...
                        <div class="col-4 form-group ">
                           ...
                           <select class="form-control selectpicker" required name="vendor_id" data-style="btn-default" data-live-search="true">
                              <?php
                              $vendor = $this->db->get_where('registration',array('status'=>1,'role'=>1))->result_object();
                              foreach($vendor as $data)
                                 {
                                  ?>
                              <option value="<?=$data->id ?>"><?=$data->username ?> [<?=$data->user_id ?>]</option>
                           <?php } ?>
                           </select>
                        </div>
