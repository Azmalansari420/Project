            ...
            // die;
             $this->db->where('requestid', $requestid);
                ...
                if(!empty($vendor_id))
                {
                  ...
                  $registration = $this->db->get_where('registration',array('id'=>$vendor_id))->result_object();
                  $vendor_com = $registration[0]->comission;
                ...
                if(!empty($dealer_id))
                {
                  $registration = $this->db->get_where('registration',array('id'=>$dealer_id))->result_object();
                  $dealer_comis = $registration[0]->comission;
