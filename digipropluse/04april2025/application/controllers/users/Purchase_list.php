...
class purchase_list extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'load_path'=>'users/purchase_list/',
						   	'redirect_path'=>'users/purchase_list/',
						   	...
						   	'multiple_delete'=>'users/purchase_list/delete_all',
   ...
   //--check user login or not
	...
	function add()
	{
		...
		$data['back_url'] = base_url('users/'.$this->arr_values['back_url'].'/listing');
	...
	function listing()
	{
		...
		$data['page_title'] = $this->arr_values['page_title'];
		$data['back_url'] = base_url('users/'.$this->arr_values['back_url'].'/listing');
		$data['add_url'] = base_url('users/'.$this->arr_values['add_url'].'/add');
		$data['edit_url'] = base_url('users/'.$this->arr_values['edit_url'].'/edit/');
		$data['delete_url'] = base_url('users/'.$this->arr_values['delete_url'].'/delete/');
		$data['view_url'] = base_url('users/'.$this->arr_values['view_url'].'/view/');
		$data['status_value'] = base_url('users/'.$this->arr_values['status_value'].'/new_status');
