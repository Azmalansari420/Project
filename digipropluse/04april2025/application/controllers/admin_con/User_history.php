...
class User_history extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'table_url'=>'admin/user_history/table',
						   	'status_value'=>'user_history',
						   	'multiple_delete'=>'admin_con/user_history/delete_all',
						   	'pagination_url'=>'admin_con/user_history/get_table_data',
						   	'controller_name'=>'user_history',
						   	'page_name'=>'user_history.php',
						   	'pagination_limit'=>'10',
						   ); 
   ...
   //--check user login or not
	...
	public function get_table_data() 
	{
	  ...
	  $this->db->or_like('request_id', $search);
