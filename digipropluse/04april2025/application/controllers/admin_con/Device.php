...
class Device extends CI_Controller
{
	...
	protected $arr_values = array(
						   	'page_title'=>'Device',
						   	'table_name'=>'device',
						   	'upload_path'=>'media/uploads/device/',
						   	'load_path'=>'admin/device/',
						   	'redirect_path'=>'admin_con/device/',
						   	'back_url'=>'device',
						   	'add_url'=>'device',
						   	'edit_url'=>'device',
						   	'delete_url'=>'device',
						   	'view_url'=>'device',
						   	'table_url'=>'admin/device/table',
						   	'status_value'=>'device',
						   	'multiple_delete'=>'admin_con/device/delete_all',
						   	'pagination_url'=>'admin_con/device/get_table_data',
						   	'controller_name'=>'device',
						   	'page_name'=>'device.php',
						   	'pagination_limit'=>'10',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		check_controller_inner_access(14,2);
