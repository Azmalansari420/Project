...
class Plan_purchase extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'Plan Purchase',
						   	'table_name'=>'plan_purchase',
						   	'upload_path'=>'media/uploads/plan_purchase/',
						   	'load_path'=>'admin/plan_purchase/',
						   	'redirect_path'=>'admin_con/plan_purchase/',
						   	'back_url'=>'plan_purchase',
						   	'add_url'=>'plan_purchase',
						   	'edit_url'=>'plan_purchase',
						   	'delete_url'=>'plan_purchase',
						   	'view_url'=>'plan_purchase',
						   	'table_url'=>'admin/plan_purchase/table',
						   	'status_value'=>'plan_purchase',
						   	'multiple_delete'=>'admin_con/plan_purchase/delete_all',
						   	'pagination_url'=>'admin_con/plan_purchase/get_table_data',
						   	'controller_name'=>'plan_purchase',
						   	'page_name'=>'plan_purchase.php',
						   	'pagination_limit'=>'10',
						   ); 
   ...
   //--check user login or not
	...
	public function get_table_data() 
	{
	  ...
	  $this->db->or_like('plan_name', $search);
	...
	function purchase_kyc_details()
	{
		check_controller_inner_access(9,5);		 
		$data['page_title'] = $this->arr_values['page_title'];
		$data['upload_path'] = $this->arr_values['upload_path'];
		$data['back_url'] = base_url('admin_con/'.$this->arr_values['back_url'].'/listing');
		$this->load->view($this->arr_values['load_path'].'kyc-detail',$data);
	}
