              ...
              <div class="vs-destination-single">
                ...
                <div class="destination-single-info">
                  <figure class="destination-single-img d-block">
                    <img
                      src="assets/img/destination/destination-single-1.png"
                      alt="destination"
                    />
                  </figure>
                  <div class="destination-single-px">
                    <div class="trip-info">
                      <div class="trip-info-box">
                        ...
                        <h6 class="info-title">Bus, Airlines</h6>
                      </div>
                      <div class="trip-info-box">
                        <div class="header">
                          <svg
                        ...
                        <h6 class="info-title">Kathmandu</h6>
                      </div>
                      <div class="trip-info-box">
                        <div class="header">
                          <svg
                      ...
                      <div class="trip-info-box">
                        ...
                        <h6 class="info-title">3 Stars Hotels</h6>
                      </div>
                      <div class="trip-info-box">
                        <div class="header">
                          <svg
                        ...
                        <h6 class="info-title">Feb, Mar, Apr & May</h6>
                      </div>
                      <div class="trip-info-box">
                        <div class="header">
                          <svg
                      ...
                      <div class="trip-info-box">
                        ...
                        <h6 class="info-title">5,416 metres</h6>
                      </div>
                      <div class="trip-info-box">
                        <div class="header">
                          <svg
                        ...
                        <h6 class="info-title">Eco-Tour, Hiking</h6>
                      </div>
                      <div class="trip-info-box">
                        <div class="header">
                          <svg
                    ...
                    <div id="current" class="destination-overview tab-content">
                      ...
                      <p>
                        Rainbow’s high techngy systems with the help of reoving
                        unseen dusothtls miyoutes and bed bus harmfully diseases
                        because of dirters. This also includes hagig home bes
                        linens share provid disg specialized deep unseen unseen
                        echngy mites client.
                      </p>
                      <p>
                        Dainbow’s high techngy systems with the help of reoving
                        unseen dusothtls miyoutes and bed bus harmfully diseases
                        because of dirters. This also includes hagig home bes
                        linens share provid disg specialized deep unseen unseen
                        echngy mites client.
                      ...
                      <ul class="custom-ul">
                        <li>
                          ...
                          Visit the Pyramids of Giza and see
                        </li>
                        <li>
                          <i class="fa-solid fa-circle-arrow-right"></i>
                    ...
                    <div id="itinerary" class="destination-ltinerary tab-content">
                      ...
                      <div class="d-flex gap-2 gap-xl-4">
                        ...
                        <div
                          class="accordion-style2 accordion flex-grow-1"
                        ...
                        >
                          <div class="accordion-item">
                            <h6 class="accordion-header">
                              ...
                              >
                                Day 01 : Kathmandu to Pokhara (By flight or
                                Bus), the city of Lakes
                              </button>
                            </h6>
                            <div
                              id="collapseOne_2"
                            ...
                            >
                              <div class="accordion-body">
                                Travel is movement of people between relatively
                                distant geograp location, andca involve travels
                                byfo, bicycle, autmobile, train, boat, bus,
                                airplane, or other means, without luggage, and
                                can be one way or round trip. Travel can also
                                include successive.
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="accordion-item">
                            <h6 class="accordion-header">
                              <button
                                ...
                                type="button"
                                data-bs-toggle="collapse"
                                data-bs-target="#collapseThree_1"
                                aria-expanded="false"
                          ...
                          <div class="accordion-item">
                            <h6 class="accordion-header">
                              <button
                                ...
                                type="button"
                                data-bs-toggle="collapse"
                                data-bs-target="#collapseFive_1"
                                aria-expanded="false"
                                aria-controls="collapseFive_1"
                              >
                                Day 05 : Chomrong to Dobhan (Dovan), the city of
                                Lakes
                              </button>
                            </h6>
                            <div
                          ...
                          <div class="accordion-item">
                            <h6 class="accordion-header">
                              ...
                              >
                                Day 06 : Pokhara (By flight or Bus), the city of
                                Lakes
                              </button>
                            </h6>
                            <div
                          ...
                          <div class="accordion-item">
                            <h6 class="accordion-header">
                              ...
                              >
                                Day 07 : Pokhara (By flight or Bus), the city of
                                Lakes
                              </button>
                            </h6>
                            <div
                    ...
                    <div id="cost" class="destination-cost tab-content">
                      ...
                      <div class="includes">
                        ...
                        <ul class="custom-ul">
                          ...
                          <li>
                            <i class="fa-solid fa-circle-arrow-right"></i>
                            Travel through the Sherpa villages of Namche,
                            Khumjung, Khunde, and Dingboche
                          </li>
                          <li>
                            <i class="fa-solid fa-circle-arrow-right"></i>
                            Trek to the world-famous Everest Base Camp
                      ...
                      >
                        <div class="accordion-item">
                          ...
                          >
                            <div class="accordion-body">
                              ...
                              distant geograp location, andca involve travels
                              byfo, bicycle, autmobile, train, boat, bus,
                              airplane, or other means, without luggage, and can
                              be one way or round trip. Travel can also include
                              successive.
                            </div>
                          </div>
                        </div>
                        <div class="accordion-item">
                          <h6 class="accordion-header">
                            ...
                            >
                              How long do we walk every day when doing Annapurna
                              Base Camp trekking?
                            </button>
                          </h6>
                          <div
                        ...
                        <div class="accordion-item">
                          <h6 class="accordion-header">
                            ...
                            >
                              What about battery charging and hot shower
                              facilities?
                            </button>
                          </h6>
                          <div
                    ...
                    <div id="map" class="destination-map tab-content">
                      <h4 class="title">Tour Map</h4>
                      <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5122760.8817607!2d10.454119350000001!3d51.17580699999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2a0557af929a470f%3A0x1429b89d710c995b!2sVecuro%20Soft%20%7C%20Templates%20%26%20Themes!5e0!3m2!1sen!2sbd!4v1738631298056!5m2!1sen!2sbd"
                        style="border: 0"
                        allowfullscreen=""
                        loading="lazy"
                    ...
                    <div id="review" class="destination-request tab-content">
                      ...
                      <div class="row">
                        <div class="col-12">
                          <form
                            action="https://html.vecurosoft.com/tripix/tripix-demo/index.php"
                            method="post"
                            class="form-style2"
                          >
                            <div class="row">
                ...
                >
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <div class="header">
                          <span class="offer">8% off</span>
                          <div
                            class="package-wrapper d-flex justify-content-between gap-2"
                          >
                        ...
                        <div class="footer">
                          <button class="vs-btn style9 w-100">
                            Check Availability
                          </button>
                          <p>
            ...
            <div class="col-md-6 col-xl-4">
              <div class="tour-package-box style-3 bg-white-color">
                ...
                <div class="tour-package-content">
                  ...
                  <h5 class="title line-clamp-2">
                    <a href="packages.php">barcelona city beach hotels of the Lifetime</a>
                  </h5>
                  <div class="tour-package-footer">
                    <div class="tour-duration">
                      <i class="fa-regular fa-clock"></i>
            ...
            <div class="col-md-6 col-xl-4">
              <div class="tour-package-box style-3 bg-white-color">
                ...
                <div class="tour-package-content">
                  ...
                  <h5 class="title line-clamp-2">
                    <a href="packages.php">golden sand and shallow waters Lifetime</a>
                  </h5>
                  <div class="tour-package-footer">
                    <div class="tour-duration">
                      <i class="fa-regular fa-clock"></i>
