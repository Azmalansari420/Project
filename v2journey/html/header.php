...
<head>
    ...
    <meta name="developer" content="V2Journey" />
    ...
    <div class="vs-menu-wrapper">
      <div class="vs-menu-area text-center">
        <div class="mobile-logo">
          <a href="index.php"
            ><img src="assets/logo.png" alt="Carmax" class="logo header-logomobile-img"
          /></a>
        ...
        <div class="vs-mobile-menu">
          <ul>
            ...
            <li class="menu-item-has-children mega-menu-wrap">
              ...
              <ul class="mega-menu">
                <li>
                  <a href="javascript:void(0)">Packages Title</a>
                  <ul>
                    <li><a href="package-details.php">Packages Name</a></li>
                    <li><a href="package-details.php">Packages Name 2</a></li>
                    <li><a href="package-details.php">Packages Name 3</a></li>
                    <li><a href="package-details.php">Packages Name 4</a></li>                    
                  </ul>
                </li>
                <li>
                  <a href="javascript:void(0)">Packages Title 2</a>
                  <ul>
                    <li><a href="package-details.php">Packages Name</a></li>
                    <li><a href="package-details.php">Packages Name 2</a></li>
                    <li><a href="package-details.php">Packages Name 3</a></li>
                ...
                <li>
                  <a href="javascript:void(0)">Packages Title 3</a>
                  <ul>
                    <li><a href="package-details.php">Packages Name</a></li>
                    <li><a href="package-details.php">Packages Name 2</a></li>
                    <li><a href="package-details.php">Packages Name 3</a></li>
                ...
                <li>
                  <a href="javascript:void(0)">Packages Title 4</a>
                  <ul>
                    <li><a href="package-details.php">Packages Name</a></li>
                    <li><a href="package-details.php">Packages Name 2</a></li>
                    <li><a href="package-details.php">Packages Name 3</a></li>
        ...
        <div class="row justify-content-between align-items-center">
          <div class="col-auto col-lg-2">
            ...
            <div class="logo d-none d-lg-block">
              <a href="index.php"
                ><img src="assets/logo.png" alt="Carmax" class="logo"
              /></a>
            </div>
          </div>
                  ...
                  >
                    <a href="index.php"
                      ><img
                        src="assets/logo.png"
                        alt="Luxrio"
                        class="logo header-logo-img" style=""
                    /></a>
