		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="d-lg-flex align-items-center mb-4 gap-3">
				  ...
				  <div class="ms-auto">
				  	<a href="<?php echo base_url('admin_con/partner/listing');?>" class="btn btn-light radius-30 mt-2 mt-lg-0">
											...
											<div class="col-lg-4">
												<div class="card">
													<div class="card-body" style="padding:0;">
														...
														Upload image
													<img id="blah" src="<?php echo base_url(); ?>media/uploads/partner/<?php echo $EDITDATA[0]->image; ?>" class="sd" style="width: 100%; height: 100%; position: relative; top: -22px;">
											...
											<div class="col-lg-8">
												<div class="card">
													<div class="card-body">
														...
														<div class="col-sm-9">
															<input type="text" class="form-select" name="title" value="<?php echo $EDITDATA[0]->title; ?>">
														</div>
													</div>
													...
													<div class="row mb-3">
														...
														<div class="col-sm-9">
															<input type="text" class="form-select" name="url" value="<?php echo $EDITDATA[0]->url; ?>">
														</div>
													</div>
