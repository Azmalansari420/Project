...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: view-application.php"); // Redirect to display page
    exit();
}
?>
...
<html dir="ltr" lang="zxx">
   <head>
      ...
      <meta name="twitter:url" content="https://indiaregistrationonline.org/">
       <title>Gatway To Success | Registration</title>
               ...
               <div class="col-md-12">
                  <div class="breadcrumb-wrapper">
                     <div class="page-heading">
                        ...
                        <p>Sell Your Product To Government Department</p>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="col-lg-7 position-relative">
                  <div class="comment-respond">
                     <div class="formheadings">
                        <h3>G.E.M Registration Information Form
                           G.E.M रजिस्ट्रेशन जानकारी फॉर्म
                        </h3>
                     </div>
                        ...
                        <div class="row ">
                           <div class="col-md-6">
                              <div class="contacts-name">
                                 ...
                                 <input name="name" type="text" placeholder="NAME OF THE APPLICANT" required id="name" >
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="contacts-name">
                                 <label>MOBILE NUMBER OF APPLICANT <br> आवेदक का मोबाइल नंबर *</label>
                                 <input name="mobile" type="number" placeholder="MOBILE NUMBER OF APPLICANT" required>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="contacts-name">
                                 <label>EMAIL ID OF APPLICANT <br> आवेदक की ईमेल आईडी *</label>
                                 <input name="email" type="email" placeholder="EMAIL ID OF APPLICANT" required>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="contacts-name">
                                 <label>DATE OF BIRTH <br> जन्म की तारीख</label>
                                 <input name="dob" type="date" placeholder="MOBILE NUMBER OF APPLICANT" required>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="contacts-name">
                                 <label>BUSINESS NAME <br> व्यवसाय नाम</label>
                                 <input name="bussiness_name" type="text" placeholder="BUSINESS NAME" required>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="contacts-name">
                                 <label>TYPE OF ORGANISATION <br> संगठन का प्रकार *</label>
                                 <select name="type_of_organisation" required>
                           ...
                           <div class="col-md-6">
                              <div class="contacts-name">
                                 ...
                                 <input name="business_start_date" type="date" placeholder="BUSINESS START DATE" required>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="contacts-name">
                                 <label>Business Deals in Product/Services <br>आप की कंपनी प्रोडक्ट में डील करती है या सर्विसेज में *</label>
                                 <select name="business_deals_in_ps" required>
                           ...
                           <div class="col-md-12">
                              <div class="contacts-name">
                                 <label>BUSINESS OFFICE ADDRESS <br> व्यापार कार्यालय का पता *</label>
                                 <input name="busine_offadd" type="text" placeholder="BUSINESS OFFICE ADDRESS" required>
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="contacts-name">
                                 <label>PINCODE <br> पिन कोड *</label>
                           ...
                           <div class="col-md-4">
                              <div class="contacts-name">
                                 ...
                                 <input name="distric" type="text" placeholder="Enter Your District" required>
                              </div>
                           </div>
                           <div class="col-lg-12">
                              <div class="contacts-name">
                                 <span><input type="checkbox"> I accept customer  <a href="customer-dispute-policy.php"> dispute policy</a>.</span>
                              </div>
                           </div>
                           <div class="col-lg-12">
                              <div class="contacts-name">
                                 <span><label for="customCheck1">
                                 <input type="checkbox" id="customCheck1" required=""> 
                                 I hereby affirm that I have fully read, understood, and agreed to the <a href="terms-and-conditions.php"><font color="Dark blue">Terms of Service</font></a>. By clicking the 'Submit Application' button, I acknowledge that the purpose of this form is to formally initiate a service request with a private firm for the engagement of a professional specialist to assist in the process of obtaining a Food Safety and Standards Authority of India Registration License. I expressly recognize that this platform operates as a private and independent entity, and holds no affiliation, authorization, endorsement, or association—whether direct or implied—with the Food Safety and Standards Authority of India or any government body or agency.
                                 </label></span>
                              </div>
                           </div>
                           <div class="col-12">
         ...
         <div class="row ">
            <div class="col-lg-6">
               <div class="section-title text-center style-2 ">
                  <h2 class="title">Benefits Of G.E.M Registration</h2>
               </div>
               <div class="accordion accordion-flush" id="accordionFlushExampleTWO">
                  ...
                  <div class="accordion-item active wow animate__animated animate__flipInX animate__slow">
                     ...
                     <div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExampleTWO">
                        <div class="accordion-body">Directly sell products and services to multiple government departments, PSUs, and ministries.</div>
                     </div>
                  </div>
                  <!-- Item 2 -->
                  <div class="accordion-item wow animate__animated animate__flipInX animate__slow">
                     ...
                     <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExampleTWO">
                        <div class="accordion-body">100% online process with minimal paperwork and faster procurement cycle.</div>
                     </div>
                  </div>
                  <!-- Item 3 -->
                  <div class="accordion-item wow animate__animated animate__flipInX animate__slow">
                     ...
                     <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExampleTWO">
                        <div class="accordion-body">A fair, open, and competitive marketplace with equal opportunities for all sellers.</div>
                     </div>
                  </div>
                  <!-- Item 4 -->
                  <div class="accordion-item wow animate__animated animate__flipInX animate__slow">
                     ...
                     <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExampleTWO">
                        <div class="accordion-body">Buyers are bound to make payments within the specified time, ensuring better cash flow.</div>
                     </div>
                  </div>
                  <!-- Item 5 -->
                  <div class="accordion-item wow animate__animated animate__flipInX animate__slow">
                     ...
                     <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExampleTWO">
                        <div class="accordion-body">Opportunity to showcase products/services nationwide to verified government buyers.</div>
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-lg-6">
               <div class="section-title text-center style-2 ">
                  <h2 class="title">FAQ Of G.E.M Registration</h2>
               </div>
               <!-- Accordion 2: FAQ of G.E.M Registration -->
               <div class="accordion accordion-flush" id="accordionFAQ">
                  ...
                  <div class="accordion-item">
                     <h2 class="accordion-header" id="faq-headingOne">
                        ...
                        What is G.E.M Registration ?
                        </button>
                     </h2>
                     <div id="faq-collapseOne" class="accordion-collapse collapse" aria-labelledby="faq-headingOne" data-bs-parent="#accordionFAQ">
                        <div class="accordion-body">
                           G.E.M (Government e-Marketplace) registration is the process for sellers, service providers, and manufacturers to list their products/services on the government’s official e-procurement portal to directly sell to government departments and PSUs.
                        </div>
                     </div>
                  </div>
                  <!-- FAQ 2 -->
                  <div class="accordion-item">
                     <h2 class="accordion-header" id="faq-headingTwo">
                        ...
                        Who can register on G.E.M Portal?
                        </button>
                     </h2>
                     <div id="faq-collapseTwo" class="accordion-collapse collapse" aria-labelledby="faq-headingTwo" data-bs-parent="#accordionFAQ">
                        <div class="accordion-body">
                           Any manufacturer, trader, service provider, MSME, startup, or established company with a valid PAN, GST, and bank account can register as a seller on the G.E.M portal.
                        </div>
                     </div>
                  </div>
                  <!-- FAQ 3 -->
                  <div class="accordion-item">
                     <h2 class="accordion-header" id="faq-headingThree">
                        ...
                        Is G.E.M registration mandatory to sell to government departments?
                        </button>
                     </h2>
                     <div id="faq-collapseThree" class="accordion-collapse collapse" aria-labelledby="faq-headingThree" data-bs-parent="#accordionFAQ">
                        <div class="accordion-body">
                           Yes, for online procurement, government departments and PSUs purchase only through the G.E.M portal. Without registration, sellers cannot directly participate in this marketplace.
                        </div>
                     </div>
                  </div>
                  <!-- FAQ 4 -->
                  <div class="accordion-item">
                     <h2 class="accordion-header" id="faq-headingFour">
                        ...
                        What documents are required for G.E.M Registration?
                        </button>
                     </h2>
                     <div id="faq-collapseFour" class="accordion-collapse collapse" aria-labelledby="faq-headingFour" data-bs-parent="#accordionFAQ">
                        <div class="accordion-body">
                           Basic documents include PAN, GST certificate, Aadhaar of the authorized person, Udyam/MSME registration (if applicable), bank account details, and product/service details.
                        </div>
                     </div>
                  </div>
                  <!-- FAQ 5 -->
                  <div class="accordion-item">
                     <h2 class="accordion-header" id="faq-headingFive">
                        ...
                        What are the charges for G.E.M Registration?
                        </button>
                     </h2>
                     <div id="faq-collapseFive" class="accordion-collapse collapse" aria-labelledby="faq-headingFive" data-bs-parent="#accordionFAQ">
                        <div class="accordion-body">
                           G.E.M registration itself is free of cost. However, sellers need to pay an annual fee based on turnover (if exceeding ₹20 lakh) for catalog listing and transaction charges on confirmed orders.
                        </div>
                     </div>
                  </div>
               </div>
